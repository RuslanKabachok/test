          ...
          return (
            ...
            (x.buildCallback = function () {
              ...
              (this.c9 = b(
                ...
                e.addEventListener('keydown', this.v9.bind(this)),
                e.classList.add('amp-social-share-'.concat(a));
            }),
            (x.layoutCallback = function () {
              var t = this;
              if (!this.c9) return r || (r = Promise.resolve(void 0));
            ...
            (x.v9 = function (t) {
              var e = t.key;
              (' ' != e && 'Enter' != e) || (t.preventDefault(), this.p9());
            }),
            (x.ba = function () {
              this.p9();
            }),
            (x.p9 = function () {
              b(this.f9 && this.h, 'Clicked before href is set.');
              var t = this.f9,
                r = this.h;
              if ('navigator-share:' === this.c9) {
