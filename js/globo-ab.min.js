                  ...
                  h.open(e, v, !0),
                    ...
                    (h.onload = function () {
                      h.status >= 200 && h.status < 400
                        ? s.callIfDefined(i, h)
                        : s.callIfDefined(a, s.handleError(h, v));
                    }),
                    (h.onerror = function (e) {
                      s.callIfDefined(a, s.handleError(e, v));
                    }),
                ...
                value: function (e) {
                  ...
                  return new Promise(function (n, r) {
                    t.abEndpoint.selectedAlternatives(
                      ...
                      t.options(),
                      function (r) {
                        var i = s.parseRequest(r.responseText, t, t.options()),
                          o = i[e];
                        n(o);
                      },
                      function (e) {
                ...
                value: function (e) {
                  ...
                  return new Promise(function (n, r) {
                    t.abEndpoint.selectedDrawedExperiment(
                      ...
                      t.options(),
                      function (e) {
                        var r = o.parseRequest(e.responseText, t, t.options());
                        n(r);
                      },
                      function (e) {
                        r(e);
          ...
          return (
            i(e, [
              ...
              },
              {
                key: 'location',
                value: function () {
                  return new u(this._getServer(this.env), this.options());
                },
              },
              {
                key: 'impression',
