!(function (e, t) {
  ...
  return (function (e) {
        ...
        var o = n(4),
          i = (function () {
            ...
            return (
              ...
              (e.server = function (t) {
                (e.host = t || ''),
                  (e.environment = e.host.includes('globoi.com')
                    ? 'qa1'
                    : e.host.includes('globo.com')
                    ? 'prod'
                    : 'local');
              }),
              (e.Experiment = (function () {
                ...
                return (
                  (t.prototype.recordImpression = function () {
                    var t =
              ...
              (e.recordMetric = function (n, r) {
                var o =
                  ...
                  a = { experiment: r.experiment, alternative: r.alternative },
                  u = void 0;
                o && void 0 !== o.extraHeaders && (u = o.extraHeaders),
                  void 0 !== t.navigator &&
                  t.navigator.sendBeacon &&
                  void 0 === u
                    ? t.navigator.sendBeacon(e.host + i, JSON.stringify(a))
                    : e.doRequest('PUT', i, null, a, null, null, u),
                  e.sendHorizon('ab', {
                    metricId: n,
              ...
              (e.getExperimentSettings = function (t, n) {
                ...
                if (
                  t &&
                  r['ab-client-context'] === t &&
                  r['ab-client-experiment']
                ) {
                  var o = {
                ...
                return n &&
                  r['ab-client-experiment'] === n &&
                  r['ab-client-alternative']
                  ? { alternative: r['ab-client-alternative'] }
                  : {};
              }),
              ...
              (e.recordMABMetric = function (n, r, o, i, a) {
                ...
                r.metadata
                  ...
                  : o && o.metadata && (s.metadata = o.metadata),
                  e.sendHorizon('mab', {
                    metricId: n,
                    algorithm: 'ucb1',
                    experiment: r.experiment,
                  ...
                  void 0 !== t.navigator && t.navigator.sendBeacon
                    ? t.navigator.sendBeacon(e.host + u, JSON.stringify(s))
                    : e.doRequest('POST', u, {}, s, i, a);
              }),
              (e.getSelectedArm = function (t, n, r) {
                var o =
                  ...
                  a = '',
                  u = 'GET';
                i && void 0 !== i.skipImpression && !0 === i.skipImpression
                  ? (a = '/mab/' + t + '/choose')
                  : ((a = '/mab/' + t + '/chooseAndIncrement'), (u = 'POST'));
                var s = function (o) {
                  var i = JSON.parse(o.responseText);
                  (i.experiment = t),
                    n && n.metadata && (i.metadata = n.metadata),
                    e.callIfDefined(r, new e.MABExperiment(i));
                };
          ...
          return (function (e) {
              ...
              var o = r(n(8)),
                ...
                a = {
                  useQAConfiguration: function () {
                    (i.HORIZON_TRACK_HOST =
                      'https://horizon-track.qa.globoi.com'),
                ...
                f = (function () {
                  function e(t, n) {
                    ...
                    !(function (e, t) {
                      ...
                      (this.tenant = t || u.default.mustBeDefined('tenant')),
                      (this.deviceGroup =
                        n || u.default.mustBeDefined('deviceGroup')),
                      (this.defaultContentType = o),
                      (this.validator = a.default),
                      (this.clientVersion = i.default.PACKAGE_VERSION),
                        ...
                        value: function (e) {
                          ...
                          r.contentType ||
                            (this.defaultContentType ||
                              u.default.mustBeDefined('contentType'),
              ...
              var o =
                ...
                f = function (e) {
                  return null === e
                    ...
                    ? null
                    : u.default.INVALID_DATE;
                };
              t.default = {
                validateFor: function (e, t) {
                  if (!l())
                    throw new Error(
                      u.default.ERROR_LOADING_RESOURCE +
                        ' Validator is not ready.'
                    );
                  if (!t)
                    throw new Error(
                      u.default.INVALID_DATA + ' Argument: schema.'
                    );
                  if (!/\d+\.\d+/.test(e.version))
                    throw new Error(u.default.INVALID_VERSION_FORMAT);
                  if (!tv4.validate(e.properties, t))
                    throw new Error(
                      u.default.INVALID_DATA +
                        ' ' +
                        e.id +
                        ' ' +
                        e.version +
                ...
                onReady: function (e) {
                  if (l()) return e();
                  if (c.ready.length > s.default.HORIZON_CALLBACK_STACK_LIMIT)
                    throw new Error(
                      u.default.LIMIT_EXCEEDED + ' Validator callback stack.'
                    );
                  return c.ready.unshift(e);
                },
                load: function () {
                  a.default.isDefined('tv4') ||
                    (0, a.default)(
                      [s.default.SCHEMA_VALIDATOR_SCRIPT_URL],
                      'tv4',
                      {
                        async: !0,
                        numRetries:
                          s.default.SCHEMA_VALIDATOR_SCRIPT_MAX_RETRIES,
                        success: function () {
                        ...
                        error: function (e) {
                          throw new Error(
                            u.default.SCHEMA_VALIDATOR_ERROR_LOADING + ' ' + e
                          );
                        },
                      }
                    );
                    ...
                    typeof (r = function () {
                      ...
                      function n(e, t, r, i) {
                        ...
                        (i = i || 0),
                          /(^css!|\.css$)/.test(e)
                            ? ((a = !0),
                              ((u = s.createElement('link')).rel =
                                'stylesheet'),
                              (u.href = d))
                            : /(^img!|\.(png|gif|jpg|svg)$)/.test(e)
                            ? ((u = s.createElement('img')).src = d)
                            : (((u = s.createElement('script')).src = e),
                              (u.async = void 0 === c || c)),
                          (u.onload =
                            u.onerror =
                            u.onbeforeload =
                ...
                h = (function () {
                  function e(t, n, r) {
                    ...
                    !(function (e, t) {
                      ...
                      (this.currentTenant =
                        t || l.default.mustBeDefined('tenant')),
                      (this.instanceID =
                        n || l.default.mustBeDefined('instanceID')),
                      (this.deviceGroup =
                        r || l.default.mustBeDefined('deviceGroup')),
                      (this.queue = new f.default(
                        c.default.EVENTS_BUFFER_SIZE
                      )),
                      new d.default()
                        .every(c.default.EVENTS_SENDER_INTERVAL)
                        .call(function () {
                          o.queue = o.filterQueue();
                          var e = o.prepareRequest();
                          o.dispatch(e, c.default.HORIZON_REQUEST_ENCODING) ||
                        ...
                        .call(function (e) {
                          var t = c.default.EVENTS_SENDER_INTERVAL,
                            ...
                            r =
                              Number(a.default.get('_hzt.interval')) ||
                              c.default.EVENTS_SENDER_INTERVAL;
                          r <= n &&
                            r >= t &&
                            e.interval !== r &&
                            e.reschedule(r),
                            a.default.remove('_hzt.interval', { path: '/' });
                        })
                        .start();
                  }
                  return (
                    o(e, [
                      ...
                      },
                      {
                        ...
                        value: function () {
                          var e =
                            +Date.now() - c.default.EVENTS_DISCARD_AFTER_MSECS;
                      ...
                      },
                      {
                        ...
                        value: function (e) {
                          if (!e || (e && !e.actions))
                            throw new Error(l.default.INVALID_REQUEST);
                      ...
                      },
                      {
                        ...
                        value: function (e) {
                          if (!e.actionTs)
                            throw new Error(l.default.INVALID_TIMESTAMP);
                          this.queue.push(e);
                        },
                      },
                      {
                        ...
                        value: function () {
                          for (; this.queue.length > 0; ) {
                            ...
                            this.dispatch(
                              e,
                              c.default.HORIZON_REQUEST_ENCODING
                            );
                          }
                        },
                      },
              ...
              t.default = {
                getInstance: function (e, t) {
                  var n = v(),
                    r = e + '-' + t;
                  return (
                    n[r] || (n[r] = new h(e, c.default.HORIZON_CLIENT_UUID, t)),
                    n[r]
                  );
                },
                reset: function (e, t) {
                  (e && 0 !== e.length) || l.default.mustBeDefined('tenant'),
                    (t && 0 !== t.length) ||
                      l.default.mustBeDefined('deviceGroup');
                  var n = e + '-' + t;
                  delete v()[n];
                },
                getContextBus: v,
            ...
            function (e, t, n) {
              !(function (n) {
                ...
                r && (o = navigator.sendBeacon.bind(navigator)),
                      ...
                      for (
                        ...
                        try {
                          ...
                          if (
                            ((h = n.read
                              ? n.read(h, p)
                              : n(h, p) || h.replace(f, decodeURIComponent)),
                            this.json)
                          )
                            try {
                              h = JSON.parse(h);
              ...
              var o = r(n(17)),
                ...
                a = {
                  base64: function (e) {
                    var t = new FormData();
                    return (
                      t.append('data', o.default.encode(JSON.stringify(e))),
          ...
          return (
            o(e, [
              ...
              },
              {
                ...
                value: function () {
                  return (
                    this.getCdaaasProperty('SITE_ID') ||
                    this.getTeliumProperty('ut.profile') ||
                    'globocom'
                  );
                },
              },
              {
                ...
                value: function () {
                  return (
                    this.getCdaaasProperty('MOBILE_GROUP') ||
                    this.getTeliumProperty('platform') ||
                    'desktop'
                  );
                },
              },
              {
                ...
                value: function (e) {
                  if (
                    window.hasOwnProperty('cdaaas') &&
                    window.cdaaas.hasOwnProperty('SETTINGS')
                  )
                    return window.cdaaas.SETTINGS[e];
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e, t) {
                  var n = null;
                  'ab' === e
                    ? ((n = this.getABSignal(t)),
                      this.getHorizonClient().send(n))
                    : 'mab' === e &&
                      ((n = this.getMABSignal(t)),
                      this.getHorizonClient().send(n));
                },
              },
              {
    ...
    function (e, t, n) {
      ...
      var r = n(0),
        o = (function () {
          var e = { v2: { version: '2.3.1' } },
            t = { v1: {} };
          return (
            (e.mab = t),
            (e.v2.getMulti = function (t, n, o) {
              var i =
                  arguments.length > 3 && void 0 !== arguments[3]
                    ? arguments[3]
                    : function () {},
                a = t.join(',');
              r.server(e.v2.server),
                r.getSelectedAlternatives('experiments', a, n, o, i);
            }),
            (e.v2.get = function (t, n, o) {
              var i =
                ...
                a = {};
              n &&
                void 0 !== n.skipImpression &&
                (a.skipImpressions = n.skipImpression),
                n &&
                  void 0 !== n.extraHeaders &&
                  (a.extraHeaders = n.extraHeaders);
              var u = function (e) {
            ...
            (e.v2.getLocation = function (t, n, o) {
              ...
              void 0 === n && (n = {}),
                void 0 !== n.skipImpression &&
                  ((n.countImpressions = !n.skipImpression),
                  delete n.skipImpression),
                (n.drawed = !0);
              var a = function (e) {
                ...
                for (var i in t)
                  if (t.hasOwnProperty(i)) {
                    var a = t[i];
                    (a.experiment = i),
                      delete a.canCountImpression,
                      delete a.canCountConversion,
                      (n = new r.Experiment(a));
                  }
                r.callIfDefined(o, n);
              };
              r.server(e.v2.server),
                r.doRequest('GET', '/ab/location/' + t, n, null, a, i);
            }),
