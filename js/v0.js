  ...
  (AMP._ = AMP._ || {}),
    (self.AMP && !Array.isArray(self.AMP)) ||
      (function () {
          ...
          r = (function () {
            ...
            return (
              (t.prototype.abort = function () {
                if (!this.Ot.Pt && ((this.Ot.Pt = !0), this.Ot.Mt)) {
                  var t = {
                    type: 'abort',
                    bubbles: !1,
                    cancelable: !1,
                    target: this.Ot,
                    currentTarget: this.Ot,
                  };
                  this.Ot.Mt(t);
                }
              }),
        ...
        var M = (function () {
            function t(t, i) {
              (this.t = t), (this.It = i), (this.Rt = A());
            }
            var i = t.prototype;
            return (
              (i.define = function (t, i, n) {
                this.It.define(t, i, n);
                var r = this.Rt,
                  e = r[t];
                e && (e.resolve(), delete r[t]);
              }),
              (i.get = function (t) {
                var i = this.It.getByName(t);
                if (i) return i.ctor;
              }),
              (i.whenDefined = function (t) {
                var i = this.t;
                if ((i.Promise, T(i.SyntaxError, t), this.It.getByName(t)))
                  return h();
                var n = this.Rt,
                  r = n[t];
          ...
          S = (function () {
            ...
            return (
              ...
              (i.define = function (t, i, n) {
                ...
                (this.Tt[t] = { name: t, ctor: i }), this.Ut(t);
                for (var u, h = o(this.Dt, !0); !(u = h()).done; ) {
                  var a = u.value;
                  this.upgrade(a, t);
                }
              }),
              (i.upgrade = function (t, i) {
                for (
                  var n, r = !!i, e = i || this.Ct, s = o(this.Lt(t, e), !0);
                  !(n = s()).done;

                ) {
                  var u = n.value;
                  r ? this.Ht(u) : this.upgradeSelf(u);
                }
              }),
              ...
              (i.Ht = function (t) {
                var i = this.getByName(t.localName);
                if (i && (this.Ft(t, i), t.connectedCallback))
                  try {
                    t.connectedCallback();
                  } catch (t) {
                    d(t);
              ...
              (i.Ut = function (t) {
                ...
                if (this.Ct) this.Ct += ','.concat(t);
                  ...
                  this.Nt = n;
                  for (var r, e = o(this.Dt, !0); !(r = e()).done; ) {
                    var s = r.value;
                    n.observe(s, I);
                  }
                  !(function (t, i) {
              ...
              (i.observe = function (t) {
                this.Dt.push(t), this.Nt && this.Nt.observe(t, I);
              }),
              (i.sync = function () {
                this.Nt && this.qt(this.Nt.takeRecords());
              }),
              (i.qt = function (t) {
        ...
        var Gt = function () {
            return '01'.concat('2406131415000');
          },
          Vt = function (t, i) {
          ...
          $t = (function () {
            ...
            return (
              ...
              (i.createError = function (t) {
                return this.vn(l.apply(null, arguments));
              }),
              (i.createExpectedError = function (t) {
                return this.vn(m.apply(null, arguments));
              }),
              (i.vn = function (t) {
                return (
                  (t = f(t)),
              ...
              (i.hn = function (t) {
                return V(t[0]) ? this.dn(t[0]) : t;
              }),
              (i.dn = function (t) {
                var i,
                  n = t.shift();
                return (
                  Dt(this.win).development && this.sn(),
                  null !== (i = this.fn) && void 0 !== i && i[n]
                    ? [this.fn[n]].concat(t)
              ...
              (i.assert = function (t, i, n) {
                return V(i)
                  ? this.assert.apply(this, [t].concat(this.dn(i)))
                  : nt.apply(
                      null,
                      [this.un].concat(Array.prototype.slice.call(arguments))
                    );
              }),
        ...
        var ri = (function () {
          function t(t) {
            (this.Wt = t),
              (this.status = this.Wt.status),
              (this.statusText = this.Wt.statusText),
          ...
          return (
            (i.clone = function () {
              return et(!this.bodyUsed), new t(this.Wt);
            }),
            (i.Jt = function () {
              return (
                et(!this.bodyUsed),
                (this.bodyUsed = !0),
                Promise.resolve(this.Wt.responseText)
              );
            }),
            (i.text = function () {
              return this.Jt();
            ...
            (i.json = function () {
              return this.Jt().then(at);
            }),
            (i.arrayBuffer = function () {
              return this.Jt().then(ct);
            }),
            t
          );
        })();
        ...
        var si = (function () {
            ...
            return (
              (i.get = function (t) {
                return this.Wt.getResponseHeader(t);
              }),
              (i.has = function (t) {
                return null != this.Wt.getResponseHeader(t);
              }),
              t
            );
          })(),
        ...
        var Bi = (function () {
          function t(i, n) {
            (this.Xt = i),
              (this.Bt = D({ root: null, rootMargin: '0px 0px 0px 0px' }, n)),
              (this.Vt = []),
              (this.$t = null),
          ...
          return (
            (n.disconnect = function () {
              this.$t ? this.$t.disconnect() : (this.Vt.length = 0);
            }),
            ...
            (n.observe = function (t) {
              this.$t
                ? this.$t.observe(t)
                : -1 == this.Vt.indexOf(t) && this.Vt.push(t);
            }),
            (n.unobserve = function (t) {
              if (this.$t) this.$t.unobserve(t);
              else {
                var i = this.Vt.indexOf(t);
                -1 != i && this.Vt.splice(i, 1);
              }
            }),
            (n.Zt = function (t) {
              var i = new t(this.Xt, this.Bt);
              this.$t = i;
              for (var n, r = o(this.Vt, !0); !(n = r()).done; ) {
                var e = n.value;
                i.observe(e);
              }
              this.Vt.length = 0;
            ...
            i(t, [
              {
                key: 'root',
                get: function () {
                  return this.$t ? this.$t.root : this.Bt.root || null;
                },
              },
              {
                key: 'rootMargin',
                get: function () {
                  return this.$t ? this.$t.rootMargin : this.Bt.rootMargin;
                },
              },
              {
                key: 'thresholds',
        ...
        var Bn,
          ...
          Or = (function () {
            ...
            return (
              ...
              (i.fire = function (t) {
                if (this.yn)
                  for (var i, n = o(this.yn.slice(), !0); !(i = n()).done; )
                    (0, i.value)(t);
              }),
          ...
          Ir = (function () {
            ...
            return (
              ...
              (i.whenSignal = function (t) {
                var i,
                  n = null === (i = this.se) || void 0 === i ? void 0 : i[t];
                if (!n) {
                  var r = this.Nn[t];
                  (n =
                    null != r
              ...
              (i.signal = function (t, i) {
                ...
                if (null == this.Nn[t]) {
                  ...
                  this.Nn[t] = r;
                  var e =
                    null === (n = this.se) || void 0 === n ? void 0 : n[t];
                  null != e &&
                    e.resolve &&
              ...
              (i.reset = function (t) {
                var i;
                this.Nn[t] && delete this.Nn[t];
                var n = null === (i = this.se) || void 0 === i ? void 0 : i[t];
                n && !n.resolve && delete this.se[t];
              }),
              t
            );
          })(),
        ...
        var Gr = (function () {
          ...
          Wr = (function () {
            function t(t, i, n) {
              (this.win = t),
                (this.oe = null),
                i &&
                  ((this.oe = new Kr(t, { params: Qr(t, n) })),
                  (t.document.__AMPDOC = this.oe));
            }
            var i = t.prototype;
            return (
          ...
          Yr = (function () {
            function t(t, i, n) {
              ...
              (this.win = t),
                (this.ae = A()),
                (this.ce = i),
                (this.fe = (n && n.signals) || new Ir()),
                (this.le = (n && n.params) || A()),
                (this.ve = null),
                (this.de = {});
              var e,
                s = this.le.visibilityState;
              Zt(
                !s ||
                  'prerender' === (e = s) ||
                  'preview' === e ||
                ...
                (this.me = (n && n.visibilityState) || s || null),
                (this.J = null),
                (this.pe = new Or()),
                (this.be = null),
                (this.ge = []);
              var u = this.Wi.bind(this);
              this.ce && this.ge.push(this.ce.onVisibilityChanged(u)),
                Lr(this.win.document, u),
                this.ge.push(function () {
            ...
            return (
                  ...
                  this.ve ||
                    ...
                    this.win.document.head
                      ...
                      .forEach(function (i) {
                        ...
                        n && null !== r && void 0 === t.ve[n] && (t.ve[n] = r);
                      })),
                  A(this.ve)
                );
              }),
              ...
              (i.overrideVisibilityState = function (t) {
                this.me != t && ((this.me = t), this.Wi());
              }),
              (i.Wi = function () {
                for (
                  var t, i = Ur(this.win.document), n = Ar, r = this.ce;
                  r;
                  r = r.getParent()
                )
                ...
                if (
                  ...
                  if (t == Ar) {
                    ...
                    null != this.J && (o += Math.floor(u.now())),
                      ...
                      this.fe.signal(Br, o),
                      this.fe.signal(qr, o);
                  } else this.fe.reset(qr);
                  t == wr && this.fe.signal($r), (this.J = t), this.pe.fire();
                }
              }),
              ...
              (i.whenFirstPreviewed = function () {
                return this.fe.whenSignal($r).then(function () {});
              }),
              (i.whenFirstVisible = function () {
                return this.fe.whenSignal(Br).then(function () {});
              }),
              (i.whenNextVisible = function () {
                return this.fe.whenSignal(qr).then(function () {});
              }),
              (i.getFirstVisibleTime = function () {
                return this.fe.get(Br);
              }),
              ...
              (i.onVisibilityChanged = function (t) {
                return this.pe.add(t);
              }),
              (i.registerSingleton = function (t) {
                return !this.ae[t] && ((this.ae[t] = !0), !0);
              }),
              t
            );
          })(),
          Kr = (function (t) {
            ...
            function n(t, n) {
              var r;
              return (
                ((r = i.call(this, t, null, n)).ye = r.win.document.body
                  ? Promise.resolve(r.win.document.body)
                  : Ti(r.win.document).then(function () {
                      return r.getBody();
                    })),
                (r.we = dn(r.win.document)),
                r
              );
            }
            var r = n.prototype;
          ...
          Jr = (function (t) {
            ...
            function n(t, n, r, e) {
              var s;
              ((s = i.call(this, t, null, e)).Ae = n),
                (s.xe = r),
                (s.Ee = null);
              var u = new a();
              (s.ye = u.promise), (s.Oe = u.resolve), (s.Te = !1);
              var o = new a();
              return (s.we = o.promise), (s.Pe = o.resolve), s;
            }
            var r = n.prototype;
            return (
              (r.isSingleDoc = function () {
              ...
              (r.setBody = function (t) {
                Zt(!this.Ee), (this.Ee = t), this.Oe(t), (this.Oe = void 0);
              }),
              (r.waitForBodyOpen = function () {
                return this.ye;
              }),
              ...
              (r.setReady = function () {
                Zt(!this.Te), (this.Te = !0), this.Pe(), (this.Pe = void 0);
              }),
              (r.whenReady = function () {
                return this.we;
              }),
              ...
              (r.setMetaByName = function (t, i) {
                Zt(t), this.ve || (this.ve = A()), (this.ve[t] = i);
              }),
              n
            );
          })(Yr),
          Xr = (function (t) {
            ...
            function n(t, n, r, e) {
              var s;
              ((s = i.call(this, t, r, e)).Ae = n),
                (s.ye = s.win.document.body
                ...
                (s.Te = !1);
              var u = new a();
              return (s.we = u.promise), (s.Pe = u.resolve), s;
            }
            var r = n.prototype;
            return (
              (r.isSingleDoc = function () {
        ...
        var be,
          ...
          Re = (function () {
            function t(t, i) {
              (this.t = t), (this.Xt = i), (this.Ie = {}), (this.Se = null);
            }
            var i = t.prototype;
            return (
              (i.start = function () {
                (this.Se = this.Ie), (this.Ie = {});
              }),
              (i.resolveMatchQuery = function (t) {
                return '1' === this.Me(t, _e, '1');
              }),
              (i.resolveListQuery = function (t) {
                return this.Me(t, ke, '');
              }),
              (i.complete = function () {
                for (var t in this.Se)
                  t in this.Ie || Ce(this.Se[t], this.Xt, !1);
                this.Se = null;
              }),
              (i.dispose = function () {
                for (var t in this.Ie) Ce(this.Ie[t], this.Xt, !1);
                this.Ie = {};
              }),
              (i.Me = function (t, i, n) {
                if (!t.trim()) return n;
                var r = this.Ie[t];
                return (
                  r || (et(this.Se), (r = this.Se[t])),
                  r || Ce((r = i(this.t, t)), this.Xt, !0),
                  (this.Ie[t] = r),
                  (function (t) {
        ...
        var as,
          ...
          fs = (function () {
            function t(t) {
              (this.En = t), (this.In = 0), (this.On = 0), (this.Rn = A());
            }
            var i = t.prototype;
            return (
              (i.has = function (t) {
              ...
              (i.get = function (t) {
                var i = this.Rn[t];
                if (i) return (i.access = ++this.On), i.payload;
              }),
              (i.put = function (t, i) {
                this.has(t) || this.In++,
                  (this.Rn[t] = { payload: i, access: this.On }),
                  this.jn();
              }),
              (i.jn = function () {
                if (!(this.In <= this.En)) {
        ...
        var Gs = 'Resource',
          Vs = (function () {
            function t(t, i, n) {
              (i.__AMP__RESOURCE = this),
                ...
                (this._e = n),
                (this.ke = i.hasAttribute('placeholder')),
                (this.Ne = !1),
                (this.Ce = void 0),
                (this.je = i.isBuilt() ? 1 : 0),
                0 == this.je && i.isBuilding() && this.build(),
                (this.De = -1),
                (this.Ue = 0),
                (this.ze = null),
                (this.Le = null),
                (this.He = !1),
                (this.Ge = zi(-1e4, -1e4, 0, 0)),
                (this.Ve = null),
                (this.Fe = !1),
                (this.Be = null),
                (this.qe = null),
                (this.$e = void 0);
              var r = new a();
              (this.We = r.promise), (this.Ke = r.resolve), (this.Ye = !1);
            }
            ...
            return (
              ...
              (i.getOwner = function () {
                if (void 0 === this.Ce) {
                  for (var t = this.element; t; t = t.parentElement)
                    if (t.__AMP__OWNER) {
                      this.Ce = t.__AMP__OWNER;
                      break;
                    }
                  void 0 === this.Ce && (this.Ce = null);
                }
                return this.Ce;
              }),
              (i.hasOwner = function () {
              ...
              (i.build = function () {
                var t = this;
                return this.Ne || !this.element.isUpgraded()
                  ? null
                  : ((this.Ne = !0),
              ...
              (i.overflowCallback = function (t, i, n, r) {
                t && (this.$e = { height: i, width: n, margins: r }),
                    ...
                    (1 == this.je || t.top != r.top || e) &&
                      ...
                      (1 == this.je
                        ...
                        : (4 != this.je && 5 != this.je) ||
                          ...
                          (this.je = 2)),
                      this.hasBeenMeasured() || (this.Ve = r),
              ...
              (i.Je = function () {
                ...
                this.Ge = t.getLayoutRect(this.element);
                var i = !1;
                if (t.supportsPositionFixed() && this.isDisplayed())
                  for (
                    var n = this._e.getAmpdoc().win,
                      r = n.document.body,
                      e = this.element;
                    e && e != r;
                    e = e.offsetParent
              ...
              (i.completeCollapse = function () {
                Nr(this.element, !1),
                  (this.Ge = zi(this.Ge.left, this.Ge.top, 0, 0)),
                  (this.He = !1),
              ...
              (i.getLayoutSize = function () {
                return (
                  (i = (t = this.Ge).height), { width: t.width, height: i }
                );
                var t, i;
              }),
              (i.getLayoutBox = function () {
                if (!this.He) return this.Ge;
                var t = gr(this.element);
                return Gi(this.Ge, t.getScrollLeft(), t.getScrollTop());
              }),
              (i.getInitialLayoutBox = function () {
                return this.Ve || this.Ge;
              }),
              ...
              (i.layoutScheduled = function (t) {
                (this.je = 3), (this.element.layoutScheduleTime = t);
              }),
              (i.layoutCanceled = function () {
                this.je = this.hasBeenMeasured() ? 2 : 1;
              }),
              (i.startLayout = function () {
                var t = this;
                if (this.qe) return this.qe;
                if (4 == this.je) return h();
                if (5 == this.je) return Promise.reject(this.Le);
                if ((Zt(0 != this.je), Zt(this.isDisplayed()), 3 != this.je)) {
                ...
                if (this.Ue > 0 && !this.element.isRelayoutNeeded())
                  return (
                    Qt().fine(
                      Gs,
                ...
                Qt().fine(Gs, 'start layout:', this.debugid, 'count:', this.Ue),
                  this.Ue++,
                  (this.je = 3),
                  (this.ze = new AbortController());
                var n = this.ze.signal,
              ...
              (i.isLayoutPending = function () {
                return 4 != this.je && 5 != this.je;
              }),
              (i.loadedOnce = function () {
                return this.element.R1() ? this.element.whenLoaded() : this.We;
              }),
              (i.isInViewport = function () {
                return this.Ye && this.Xe(), this.Ye;
              }),
              ...
              (i.unlayout = function () {
                0 != this.je &&
                  1 != this.je &&
                  2 != this.je &&
                  (this.ze && (this.ze.abort(), (this.ze = null)),
          ...
          $s = (function () {
            function t(t) {
              ...
              this.Ze = t;
              var n = t.win;
              (this.bs = new n.IntersectionObserver(
                function (t) {
                  return i.ws(t);
                },
                ...
                (this.Ps = t.onVisibilityChanged(function () {
                  return i.Is();
                }));
            }
            var i = t.prototype;
            return (
              (i.dispose = function () {
                this.bs.disconnect(),
                  this.xs.clear(),
                  this.Ps && (this.Ps(), (this.Ps = null));
              }),
              (i.scheduleAsap = function (t) {
                this.xs.set(t, { asap: !0, isIntersecting: !1 }), this.Ss(t);
              }),
              (i.schedule = function (t) {
                this.xs.has(t) ||
                  (t.deferredMount()
                    ? (this.xs.set(t, { asap: !1, isIntersecting: !1 }),
                      this.bs.observe(t),
                      this.As.size > 0 &&
                        this.As.forEach(function (i, n) {
                          ji(n, t) && i.observe(t);
                        }))
                    : this.xs.set(t, { asap: !1, isIntersecting: !0 }),
                  this.Ss(t));
              }),
              (i.unschedule = function (t) {
                this.xs.has(t) &&
                  ...
                  this.bs.unobserve(t),
                  this.As.size > 0 &&
                    this.As.forEach(function (i) {
                      i.unobserve(t);
                    }),
                  this.Es && ($(this.Es, t), this.Ts()));
              }),
              (i.setContainer = function (t, i) {
                var n = this;
                if (!this.As.has(t)) {
                  var r = new this.Ze.win.IntersectionObserver(
                    function (t) {
                      return n.ws(t);
                    },
              ...
              (i.removeContainer = function (t) {
                var i = this.As.get(t);
                i && (i.disconnect(), this.As.delete(t));
              }),
              (i.Ms = function () {
                var t = this;
                this.Ze.isReady() &&
                  !this.Os &&
                  ((this.Os = !0),
                  this.Ze.win.setTimeout(function () {
                    t.Ze.signals().signal(Fs);
                  }, 50));
              }),
              (i.Is = function () {
                var t = this,
                  i = this.Ze.getVisibilityState();
                (i != Ar && i != xr && i != yr && i != wr) ||
                  this.xs.forEach(function (i, n) {
                    return t.Rs(n);
                  });
              ...
              (i.Ss = function (t) {
                var i = this.Es;
                i ? (i.includes(t) || i.push(t), this.Ts()) : this.Rs(t);
              }),
              (i.Ts = function () {
                var t = this.Ze.isReady(),
                  i = this.Es;
                if (i)
                  for (var n = 0; n < i.length; n++) {
                    var r = i[n];
                    (t || ki(r, this.Ze.getRootNode())) &&
                      (i.splice(n--, 1), this.Rs(r));
                  }
                t && ((this.Es = null), this.Ms());
              }),
              (i.ws = function (t) {
                for (var i = 0; i < t.length; i++) {
                  var n = t[i],
                  ...
                  if (s) {
                    ...
                    u !== s.isIntersecting &&
                      this.xs.set(e, { asap: s.asap, isIntersecting: u }),
                      u && this.Rs(e);
                  }
                }
              }),
              (i.Rs = function (t) {
                var i = this.Es,
                  n = !(i && i.includes(t)),
                  r = this.xs.get(t) || { asap: !1, isIntersecting: !1 },
                  e = r.asap,
                  s = r.isIntersecting,
                  u = this.Ze.getVisibilityState();
                if (
                  n &&
                  (e || s) &&
                  (u == Ar ||
            ...
            return (
              ...
              (n.ks = function (t) {
                for (
                  ...
                  if (this._s[i].priority < t) n = i + 1;
                  else {
                    if (!(i > 0 && this._s[i - 1].priority >= t)) break;
                    r = i - 1;
                  }
                return i;
              }),
              (n.forEach = function (t) {
                for (var i = this.length; i--; ) t(this._s[i].item);
              }),
              (n.dequeue = function () {
                var t = this._s.pop();
        ...
        var iu = 'not_run',
          nu = (function () {
            ...
            return (
              ...
              (i.Us = function () {
                return this.Cs.displayName || this.Cs.name;
              }),
              (i.Ds = function (t) {}),
              (i.zs = function () {
                return !1;
          ...
          ru = (function (t) {
            ...
            return (
              ...
              (r.Gs = function () {
                return this.Hs.ampdoc.isVisible();
              }),
              n
            );
          })(nu),
          eu = (function () {
            function t(t) {
              ...
              (this.ampdoc = t),
                ...
                (this.Ks = !1),
                (this.Ns = this.t.document.documentElement.hasAttribute(
                  'i-amphtml-no-boilerplate'
                )),
                this.t.addEventListener('message', function (t) {
                  'amp-macro-task' == Xe(t) && n.qs(null);
                }),
                (this.Vs = !1),
            ...
            return (
              ...
              (i.runForStartup = function (t) {
                ...
                this.Js(i, Number.POSITIVE_INFINITY);
              }),
              (i.Js = function (t, i) {
                this.Fs.enqueue(t, i), this.Ys();
              }),
              (i.Xs = function (t) {
                for (var i = this.Fs.peek(); i && i.state !== iu; )
                  this.Fs.dequeue(), (i = this.Fs.peek());
                return i && t && this.Fs.dequeue(), i;
              }),
              (i.qs = function (t) {
                var i,
                  n = this,
                  r = this.Xs(!0);
                if (!r) return (this.Ks = !1), (this.$s = 0), !1;
                try {
                  (i = Date.now()), r.js(t);
                } finally {
                  Xs.then()
              ...
              (i.Ys = function () {
                if (!this.Ks) {
                  ...
                  if (t)
                    return t.zs()
                      ? ((this.Ks = !0), void this.Qs(null))
                      : void (t.Ls() && this.t.requestIdleCallback
                          ? (function (t, i, n, r) {
                              var e = Date.now();
              ...
              var r = (function (r) {
                ...
                return (
                  (u.createdCallback = function () {
                    ...
                    (this.fo = n === au ? null : n || null),
                      this.fo || vu.push(this),
                      (this.lo = null),
                      (this.vo = 1),
                      (this.do = 0),
                      (this.mo = void 0),
                      (this.po = void 0),
                      (this.fe = new Ir()),
                      this.fo && this.fe.signal(xe);
                    var r = (function (t, i) {
                      return Gn((t = Rn(t)), i) ? Nn(t, i) : null;
                    })(t, 'performance');
                    (this.bo = r && r.isPerformanceTrackingOn()),
                      (this.yo = null),
                      i.__AMP_UPG_RES &&
                        (i.__AMP_UPG_RES(i),
                  ...
                  (u.getAmpDoc = function () {
                    return Zt(this.Ze), this.Ze;
                  }),
                  (u.getResources = function () {
                    return Zt(this._e), this._e;
                  }),
                  (u.isUpgraded = function () {
                    return 2 == this.vo;
                  }),
                  (u.whenUpgraded = function () {
                    return this.fe.whenSignal(Ee);
                  }),
                  ...
                  (u.xo = function () {
                    this.ho != te &&
                      this.lo &&
                      !this.lo.isLayoutSupported(this.ho) &&
                      (ti(
                      ...
                      ti(!1, 'Layout not supported: '.concat(this.ho)));
                  }),
                  (u.getBuildPriority = function () {
                    return this.fo ? this.fo.getBuildPriority(this) : 3;
                  }),
                  (u.getLayoutPriority = function () {
                    return this.lo ? this.lo.getLayoutPriority() : 3;
                  }),
                  (u.getDefaultActionAlias = function () {
                    return (
                      Zt(this.isUpgraded()), this.lo.getDefaultActionAlias()
                    );
                  }),
                  ...
                  (u.whenBuilt = function () {
                    return this.fe.whenSignal(Pe);
                  }),
                  (u.buildInternal = function () {
                    var t = this;
                    if ((gu(this), Zt(this.fo), this.ro)) return this.ro;
                    this.setReadyStateInternal(sn);
                    var i = this.Eo();
                    this.Oo();
                    var n = i
                      ...
                      .then(function () {
                        return Zt(t.lo).buildCallback();
                      });
                    return (this.ro = n.then(
                      function () {
                        if (
                          ((t.io = !0),
                          ...
                          t.fe.signal(Pe),
                          t.R1()
                            ? t.setReadyStateInternal(t.uo != sn ? t.uo : un)
                            : (t.setReadyStateInternal(on), t.preconnect(!1)),
                          t.no && t.Vn(),
                          t.mo && fr(oi(t)).delay(t.Io.bind(t), 1),
                          !t.getPlaceholder())
                        ) {
                  ...
                  (u.build = function () {
                    ...
                    return this.ro
                      ? this.ro
                      : this.fe.whenSignal(xe).then(function () {
                          return (
                  ...
                  (u.mountInternal = function () {
                    ...
                    this.oo = this.oo || new AbortController();
                    var i = this.oo.signal;
                    return (this.so = this.buildInternal()
                      .then(function () {
                        if ((Zt(t.R1()), !i.aborted)) {
                          t.setReadyStateInternal(
                            t.uo != un ? t.uo : t.fo.usesLoading(t) ? on : un
                          ),
                            (t.eo = !0);
                          var n = t.lo.mountCallback(i);
                          return !!n && n.then(lu);
                        }
                      })
                      .then(function (n) {
                        if (((t.oo = null), i.aborted)) throw Ls();
                        t.fe.signal(Oe),
                          (t.fo.usesLoading(t) && !n) ||
                  ...
                  (u.mount = function () {
                    ...
                    this.oo = this.oo || new AbortController();
                    var i = this.oo.signal;
                    return this.fe.whenSignal(xe).then(function () {
                  ...
                  (u.unmount = function () {
                    this.no && this.pause(),
                      this.R1()
                        ? (this.oo && (this.oo.abort(), (this.oo = null)),
                          Ws(this.getAmpDoc()).unschedule(this),
                          this.eo && this.lo.unmountCallback(),
                          (this.eo = !1),
                          (this.so = null),
                          this.So(),
                          this.no && this.wo(!0))
                  ...
                  (u.whenMounted = function () {
                    return this.fe.whenSignal(Oe);
                  }),
                  (u.whenLoaded = function () {
                    return this.fe.whenSignal(Me);
                  }),
                  (u.ensureLoaded = function (t) {
                    ...
                    return this.mount().then(function () {
                      if (i.R1())
                        return (
                          i.fo.usesLoading(i) && i.lo.ensureLoaded(),
                          i.whenLoaded()
                        );
                      var n = i.Ro();
                  ...
                  (u.setReadyStateInternal = function (t, i) {
                    if (t !== this.uo && ((this.uo = t), this.R1()))
                      switch (t) {
                        case on:
                          return (
                            this.fe.signal(Ie),
                  ...
                  (u.preconnect = function (t) {
                    ...
                    Zt(this.isUpgraded()),
                      t
                        ? this.lo.preconnectCallback(t)
                        : Zs(this.getAmpDoc(), function () {
                            i.ownerDocument &&
                              i.ownerDocument.defaultView &&
                              i.lo.preconnectCallback(t);
                          });
                  }),
                  (u.R1 = function () {
                    return !!this.fo && this.fo.R1();
                  }),
                  (u.deferredMount = function () {
                    return !!this.fo && this.fo.deferredMount(this);
                  }),
                  (u.isAlwaysFixed = function () {
                    return !!this.lo && this.lo.isAlwaysFixed();
                  }),
                  ...
                  (u.Co = function () {
                    this.yo && (this.yo.dispose(), (this.yo = null));
                  }),
                  (u.No = function () {
                    var t = this.yo;
                    if (t) {
                      ...
                      var e =
                        this.ho === re ? this.getAttribute('heights') : null;
                      if (e) {
                        var s = this.Oo();
                        s && kr(s, 'paddingTop', t.resolveListQuery(e));
                      }
                      t.complete(), this.Ro().requestMeasure();
                    }
                  }),
                  ...
                  (u.connectedCallback = function () {
                    if (
                      ((function () {
                        ...
                        void 0 !== this.po ||
                        (this.po = !!yi(this, 'template')),
                      !this.po && !this.no && Ri(this))
                    ) {
                      if (
                        ((this.no = !0),
                        this.everAttached ||
                        ...
                        (this.Ze = i), n(i, this, this.fo);
                      }
                      if (
                        (this._e || (this._e = ar(this.Ze)),
                      ...
                      if (!this.so)
                        if (
                          ...
                          this.setReadyStateInternal(
                            this.fo && this.fo.usesLoading(this) ? on : un
                          );
                        else if ((this.setReadyStateInternal(sn), !t)) {
                          var i = this.fo.getPreconnects(this);
                          if (i && i.length > 0) {
                  ...
                  (u.zo = function () {
                    var i = this;
                    if (!this.po && 1 == this.vo) {
                      var n = new (Zt(this.fo))(this);
                      this.vo = 4;
                      var r = t.Date.now(),
                        e = n.upgradeCallback();
                      if (e) {
                  ...
                  (u.Vn = function () {
                    this.io && this.lo.attachedCallback();
                  }),
                  (u.disconnect = function (t) {
                    !this.po &&
                      ...
                      ((!t && Ri(this)) ||
                        ...
                        this.lo && this.lo.detachedCallback(),
                  ...
                  (u.prerenderAllowed = function () {
                    return (
                      ...
                      !!this.fo &&
                      this.fo.prerenderAllowed(this)
                    );
                  }),
                  (u.previewAllowed = function () {
                    return !!this.fo && this.fo.previewAllowed(this);
                  }),
                  (u.isBuildRenderBlocking = function () {
                    return !!this.lo && this.lo.isBuildRenderBlocking();
                  }),
                  (u.createPlaceholder = function () {
                    return this.lo ? this.lo.createPlaceholderCallback() : null;
                  }),
                  (u.createLoaderLogo = function () {
                    return this.fo
                      ? this.fo.createLoaderLogoCallback(this)
                      : {};
                  }),
                  (u.renderOutsideViewport = function () {
                    return !!this.lo && this.lo.renderOutsideViewport();
                  }),
                  (u.idleRenderOutsideViewport = function () {
                    return !!this.lo && this.lo.idleRenderOutsideViewport();
                  }),
                  (u.getLayoutBox = function () {
                    return this.Ro().getLayoutBox();
                  }),
                  (u.getLayoutSize = function () {
                    return this.Ro().getLayoutSize();
                  }),
                  (u.getOwner = function () {
                    return this.Ro().getOwner();
                  }),
                  (u.getIntersectionChangeEntry = function () {
                    var t = this.lo
                        ? this.lo.getIntersectionElementLayoutBox()
                        : this.getLayoutBox(),
                      i = this.getOwner(),
                  ...
                  (u.isRelayoutNeeded = function () {
                    return !!this.lo && this.lo.isRelayoutNeeded();
                  }),
                  (u.getImpl = function () {
                    var t = this;
                    return (
                  ...
                  (u.pause = function () {
                    this.isBuilt() &&
                      (this.lo.pauseCallback(),
                      !this.R1() && this.lo.unlayoutOnPause() && this.Mo());
                  }),
                  (u.resume = function () {
                    this.isBuilt() && this.lo.resumeCallback();
                  }),
                  (u.unlayoutCallback = function () {
                    if ((gu(this), !this.isBuilt())) return !1;
                    this.fe.signal(Se);
                    var t = this.lo.unlayoutCallback();
                    return (
                      t && this.So(),
                  ...
                  (u.Mo = function () {
                    this.Ro().unlayout(),
                      this.no && this._e && this._e.schedulePass();
                  }),
                  (u.So = function () {
                    (this.Ue = 0),
                      (this.ao = !1),
                      ...
                      this.fe.reset(Ie),
                      this.fe.reset(Me),
                      this.fe.reset('ini-load');
                  }),
                  (u.reconstructWhenReparented = function () {
                    return !!this.lo && this.lo.reconstructWhenReparented();
                  }),
                  (u.collapse = function () {
                    this.lo && this.lo.collapse();
                  }),
                  (u.collapsedCallback = function (t) {
                    this.lo && this.lo.collapsedCallback(t);
                  }),
                  (u.expand = function () {
                    this.lo && this.lo.expand();
                  }),
                  (u.mutatedAttributesCallback = function (t) {
                    this.lo
                      ? this.lo.mutatedAttributesCallback(t)
                  ...
                  (u.getOverflowElement = function () {
                    return (
                      void 0 === this.co &&
                        ((this.co = Ai(this, 'overflow')),
                        this.co &&
                          (this.co.hasAttribute('tabindex') ||
                            this.co.setAttribute('tabindex', '0'),
                          this.co.hasAttribute('role') ||
                            this.co.setAttribute('role', 'button'))),
                      this.co
                    );
                  }),
                  (u.overflowCallback = function (t, i, n) {
                    ...
                    this.getOverflowElement(),
                      this.co
                        ? (this.co.classList.toggle('amp-visible', t),
                          (this.co.onclick = t
                            ? function () {
        ...
        var Mu = 'amp-img',
          ...
          Ru = (function (t) {
            ...
            return (
              (r.mutatedAttributesCallback = function (t) {
                if (this.Vo) {
                  ...
                  t.src &&
                    ...
                    ge(i, this.element, this.Vo, !0),
                    this.propagateDataset(this.Vo),
                    Zr(this.Vo),
                    n.R1() && !this.Vo.complete && this.setReadyState(on);
                }
              }),
              ...
              (r.$o = function () {
                if (this.Vo) return this.Vo;
                this.Go = !this.element.hasAttribute('fallback');
                var t,
                  i,
                  n = Ui(this.element);
                return (
                  n && (this.Vo = pi(this.element, '> img:not([placeholder])')),
                  (this.Vo = this.Vo || new Image()),
                  this.Vo.setAttribute('decoding', 'async'),
                  this.element.id &&
                    this.Vo.setAttribute('amp-img-id', this.element.id),
                  ...
                  n || this.element.appendChild(this.Vo),
                  this.Vo
                );
              }),
              (r.Wo = function (t) {
                ...
                if (
                  ...
                  if (n && !/[0-9]+x(?:,|$)/.test(n)) {
                    ...
                    if (this.Ko(r)) {
                      ...
                      var h = s + u;
                      t
                        ? this.Vo.setAttribute('sizes', h)
                        : this.mutateElement(function () {
                            i.Vo.setAttribute('sizes', h);
                          }),
                        (this.qo = r);
                    }
                  }
              ...
              (r.Ko = function (t) {
                return !this.Vo.hasAttribute('sizes') || t > this.qo;
              }),
              ...
              (r.mountCallback = function () {
                ...
                i ||
                  (Je(n, 'load', function () {
                    t.setReadyState(hn), t.firstLayoutCompleted(), t.Yo();
                  }),
                  Je(n, 'error', function (i) {
                    t.setReadyState(an, i), t.Jo();
                  })),
                  n.complete
              ...
              (r.layoutCallback = function () {
                ...
                var i = this.Vo;
                return (
                  (this.Fo = Je(i, 'load', function () {
                    return t.Yo();
                  })),
                  (this.Bo = Je(i, 'error', function () {
                    return t.Jo();
                  })),
              ...
              (r.Yo = function () {
                !this.Go &&
                  this.Vo.classList.contains('i-amphtml-ghost') &&
                  (this.Vo.classList.remove('i-amphtml-ghost'),
                  this.toggleFallback(!1));
              }),
              (r.Jo = function () {
                this.Go &&
                  (this.Vo.classList.add('i-amphtml-ghost'),
        ...
        var Du = 'amp-pixel',
          ju = (function (t) {
            ...
            function n(t) {
              var n;
              return ((n = i.call(this, t)).Xo = null), n;
            }
            var r = n.prototype;
            return (
              (r.isLayoutSupported = function (t) {
              ...
              (r.buildCallback = function () {
                this.element.setAttribute('aria-hidden', 'true'),
                  (this.Qo = this.element.getAttribute('referrerpolicy')),
                  this.Qo &&
                    ti(
                      'no-referrer' == this.Qo,
                      ''
                  ...
                  this.element.querySelector('img')
                    ...
                    : this.getAmpDoc()
                        .whenFirstVisible()
                        .then(this.Zo.bind(this));
              }),
              (r.Zo = function () {
                var t = this;
                if (this.Xo) return Qt().error(Du, 'duplicate pixel'), this.Xo;
                this.Xo = fr(this.win)
                  .promise(1)
                  .then(function () {
          ...
          Uu = (function () {
            ...
            return (
              ...
              (i.schedule = function (t) {
                ...
                var n = Date.now() + i;
                return (
                  (!this.isPending() || n - this.su < -10) &&
                  (this.cancel(),
                  (this.su = n),
                  (this.eu = this.iu.delay(this.uu, i)),
                  !0)
                );
              }),
              (i.hu = function () {
              ...
              (i.cancel = function () {
                this.isPending() && (this.iu.cancel(this.eu), (this.eu = -1));
              }),
              t
            );
          })();
          ...
          Ku = (function () {
            function t(t, i) {
              (this.ampdoc = t),
                ...
                (this.cu = this.ampdoc.isSingleDoc() && zu(this.au)),
                (this.fu = this.cu ? $u : null),
                (this.lu = A()),
                (this.vu = A()),
                this.addEvent('tap'),
            ...
            return (
              (i.addEvent = function (t) {
                var i = this;
                if ('tap' == t)
                  this.au.addEventListener('click', function (n) {
                    if (!n.defaultPrevented) {
                      var r = n.target;
                      i.trigger(r, t, n, 3);
                    }
                  }),
                    this.au.addEventListener('keydown', function (n) {
                      var r = n.key,
                        e = n.target;
                      if ('Enter' == r || ' ' == r) {
                  ...
                  this.au.addEventListener(t, function (n) {
                    var r = n.target;
                    i.trigger(r, t, n, 3);
                  });
                else if ('change' == t)
                  ...
                  this.au.addEventListener('input', function (t) {
                    var r = new Xu(t);
                    i.du(r), n(r);
                  });
              ...
              (i.addGlobalMethodHandler = function (t, i) {
                var n =
                  arguments.length > 2 && void 0 !== arguments[2]
                    ? arguments[2]
                    : 2;
                this.vu[t] = { handler: i, minTrust: n };
              }),
              (i.trigger = function (t, i, n, r, e) {
                return this.mu(t, i, n, r, e);
              }),
              ...
              (i.gu = function (t) {
                return this.lu[t] ? this.au : this.au.getElementById(t);
              }),
              ...
              (i.addToAllowlist = function (t, i, n) {
                var r = this;
                (n && n.includes('email') !== this.cu) ||
                  (this.fu || (this.fu = []),
                  V(i) || (i = [i]),
                  i.forEach(function (i) {
                    r.fu.some(function (n) {
                      return n.tagOrTarget == t && n.method == i;
                    }) || r.fu.push({ tagOrTarget: t, method: i });
                  }));
              }),
              (i.mu = function (t, i, n, r, e) {
                var s = this,
                  u = this.bu(t, i);
                if (!u) return !1;
                var h = Math.random(),
          ...
          so = (function () {
            ...
            return (
              ...
              (i.Mr = function (t) {
                var i = this.Eu + 1;
                if (i >= this.xu.length)
                  return { type: ro.EOF, index: this.Eu };
                var n = this.xu.charAt(i);
                if (-1 != eo.indexOf(n)) {
                  for (
                    i++;
                    i < this.xu.length && -1 != eo.indexOf(this.xu.charAt(i));
                    i++
                  );
                  if (i >= this.xu.length) return { type: ro.EOF, index: i };
                  n = this.xu.charAt(i);
                }
                if (
                  t &&
                  (uo(n) ||
                    ('.' == n && i + 1 < this.xu.length && uo(this.xu[i + 1])))
                ) {
                  for (var r = '.' == n, e = i + 1; e < this.xu.length; e++) {
                    var s = this.xu.charAt(e);
                    if ('.' != s) {
                      if (!uo(s)) break;
                    } else r = !0;
                  }
                  var u = this.xu.substring(i, e),
                ...
                if (-1 != '"\''.indexOf(n)) {
                  for (var h = -1, a = i + 1; a < this.xu.length; a++)
                    if (this.xu.charAt(a) == n) {
                      h = a;
                      break;
                    }
                  if (-1 == h) return { type: ro.INVALID, index: i };
                  var c = this.xu.substring(i + 1, h);
                  return (i = h), { type: ro.LITERAL, value: c, index: i };
                }
                if ('{' == n) {
                  for (var f = 1, l = -1, v = i + 1; v < this.xu.length; v++) {
                    var d = this.xu[v];
                    if (('{' == d ? f++ : '}' == d && f--, f <= 0)) {
                      l = v;
                      break;
        ...
        var go = (function () {
            function t(t) {
              this.win = t;
              var i = Jn(t);
              this.Ou = i.isSingleDoc() ? i.getSingleDoc() : null;
            }
            var i = t.prototype;
            return (
              (i.Tu = function (t, i) {
                var n = arguments,
                  r = this;
                return fo(this.win, this.Ou, t, i).then(function (t) {
                  if (t) return t;
                  if (oo(i.body)) {
                    var e = i.body;
              ...
              (i.fetch = function (t, i) {
                var n = vo(i);
                return this.Pu(t, n).then(function (t) {
                  return po(t);
                });
              }),
              (i.sendSignal = function (t, i) {
                return this.Pu(t, i).then(function (t) {
                  return po(t);
                });
              }),
            ...
            return (
              (r.fetch = function (i, n) {
                var r = this,
                  ...
                  o = !!this.Iu[u];
                if (s && o)
                  return this.Iu[u].then(function (t) {
                    return t.clone();
                  });
                ...
                return (
                  s &&
                    (this.Iu[u] = h.then(
                      function (t) {
                        return delete r.Iu[u], t.clone();
                      },
                      function (t) {
                        throw (delete r.Iu[u], t);
                      }
                    )),
                  h
                );
          ...
          Eo = (function () {
            function t(t) {
              (this.Ze = t),
                (this.Mu = mr(this.Ze)),
                (this.Ru = null),
                (this.iu = fr(this.Ze.win));
            }
            var i = t.prototype;
            return (
              (i.isSupported = function () {
                return this.Mu.isCctEmbedded() && this.Mu.isProxyOrigin();
              }),
              (i.getScopedCid = function (t) {
                var i = this;
                return this.Mu.isCctEmbedded()
                  ? (this.Ru ||
                      (this.Ru = this._u(
                        'https://ampcid.google.com/v1/cache:getClientId?key=AIzaSyDKtqGxnoeIqVM33Uf7hRSa3GJxuzR7mLc'
                      )),
                    this.Ru.then(function (n) {
                      return n ? i.ku(n, t) : null;
                    }))
              ...
              (i._u = function (t) {
                var i = this,
                  n =
                    !(arguments.length > 1 && void 0 !== arguments[1]) ||
                    arguments[1],
                  r = { publisherOrigin: Ss(this.Ze.win.location) },
                  e = 'fetchCidTimeout';
                return this.iu
                  .timeoutPromise(
                    3e4,
                    br(this.Ze.win).fetchJson(t, {
                      method: 'POST',
                      ampCors: !1,
                      credentials: 'include',
                      mode: 'cors',
        ...
        var Ro = 'GoogleCidApi',
          ...
          Uo = (function () {
            function t(t) {
              (this.t = t.win), (this.iu = fr(this.t)), (this.Nu = {});
              var i = ir(t).canonicalUrl;
              this.Cu = i ? ms(i).origin : null;
            }
            var i = t.prototype;
            return (
              (i.getScopedCid = function (t, i) {
                ...
                return this.Nu[i]
                  ...
                  : (this.Nu[i] = this.iu
                      ...
                      .then(function () {
                        if (n === Co) return Co;
                        if ((n !== No || !r.ju()) && r.Du(n)) return null;
                        (n && !r.Du(n)) || r.Uu(ko, Do);
                        var e =
                          ...
                          .then(function (e) {
                            ...
                            if (!s && e.alternateUrl) {
                              var u = ''
                                ...
                                .concat(t);
                              return r._u(u, i, n).then(r.R.bind(r));
                            }
                            return s;
                          })
                          .catch(function (t) {
              ...
              (i._u = function (t, i, n) {
                var r = { originScope: i, canonicalOrigin: this.Cu };
                return (
                  n && (r.securityToken = n),
                  this.iu.timeoutPromise(
                    Do,
                    br(this.t)
                      .fetchJson(t, {
                        method: 'POST',
              ...
              (i.R = function (t) {
                return t.optOut
                  ? (this.Uu(Co, jo), Co)
                  : t.clientId
                  ? (this.Uu(t.securityToken, jo), t.clientId)
                  : (t.alternateUrl || this.Uu(No, 36e5), null);
              }),
              (i.Uu = function (t, i) {
                t &&
                  Io(this.t, _o, t, this.zu(i), { highestAvailableDomain: !0 });
              }),
              (i.zu = function (t) {
          ...
          Lo = (function () {
            function t(t) {
              (this.Ze = t), (this.Mu = mr(this.Ze));
              var i = ir(this.Ze).canonicalUrl;
              this.Cu = i ? ms(i).origin : null;
            }
            var i = t.prototype;
            return (
              (i.isSupported = function () {
                return this.Mu.hasCapability('cid')
                  ? this.Mu.isTrustedViewer()
                  : Promise.resolve(!1);
              }),
              (i.getScopedCid = function (t, i) {
                var n = {
                  scope: i,
                  clientIdApi: !!t,
                  canonicalOrigin: this.Cu,
                };
                return (
                  t && (n.apiKey = t),
                  this.Mu.sendMessageAwaitResponse('cid', n)
                );
              }),
              t
            );
            ...
            return (
              ...
              (i.qu = function (t, i) {
                ...
                if (!Ps(e)) {
                  var s = this.$u(r);
                  return s
                    ? this.Fu.getScopedCid(s, r).then(function (e) {
                        if (e == Co) return null;
                        if (e) {
                ...
                return this.Vu.isSupported().then(function (t) {
                  if (t) {
                    var s = n.$u(r);
                    return n.Vu.getScopedCid(s, r);
                  }
                  return n.Gu.isSupported() && n.$u(r)
                    ? n.Gu.getScopedCid(r).then(function (t) {
                        return t || n.Wu(i, r, e);
                      })
                    : n.Wu(i, r, e);
                });
              ...
              (i.$u = function (t) {
                return this.Bu || (this.Bu = this.Ku()), this.Bu[t];
              }),
              (i.Ku = function () {
                var t = {},
        ...
        var th = 'Crypto',
          ih = (function () {
            ...
            return (
              (i.sha384 = function (t) {
                var i = this;
                if (
                  ('string' == typeof t && (t = ft(t)), !this.subtle || this.Ju)
                )
                  return (this.Ju || this.Xu()).then(function (i) {
                    return i(t);
                  });
                try {
              ...
              (i.importPkcsKey = function (t) {
                ...
                var i = this.Yu ? ct(JSON.stringify(t)) : t;
          ...
          rh = (function () {
            function t(t) {
              (this.Ze = t), (this.Qu = null), (this.Zu = null);
            }
            return (
              (t.prototype.get = function () {
                if (this.Qu) return this.Qu;
                var t = this.Ze,
                  i = Ms(t.getUrl()),
                  n = t.getRootNode(),
                ...
                return (this.Qu = {
                  ...
                  pageViewId: u,
                  get pageViewId64() {
                    return this.Zu || (this.Zu = Zo(t.win)), this.Zu;
                  },
                  linkRels: o,
                  viewport: h,
                  replaceParams: a,
          ...
          sh = (function () {
            function t(t) {
              this.au = t.getRootNode();
              var i = this.au.ownerDocument || this.au;
              (this.t = Zt(i.defaultView)), (this.Nt = null), (this.th = null);
            }
            var i = t.prototype;
            return (
              (i.add = function (t) {
                ...
                var n = this.th.add(t);
                return function () {
                  n(), 0 === i.th.getHandlerCount() && i.dispose();
                };
              }),
              (i.ih = function () {
                var t = this;
                if (!this.Nt) {
                  ...
                  (this.Nt = i), i.observe(this.au, eh);
                }
              }),
              (i.dispose = function () {
                this.Nt &&
        ...
        var oh = 'History',
          ...
          ah = (function () {
            function t(t, i) {
              (this.Ze = t),
                ...
                (this.eh = []),
                (this._s = []),
                this.nh.setOnStateUpdated(this.sh.bind(this));
            }
            var i = t.prototype;
            return (
              (i.cleanup = function () {
              ...
              (i.push = function (t, i) {
                var n = this;
                return this.oh(function () {
                  return n.nh.push(i).then(function (i) {
                    return n.sh(i), t && (n.eh[i.stackIndex] = t), i.stackIndex;
                  });
                }, 'push');
              }),
              (i.pop = function (t) {
                var i = this;
                return this.oh(function () {
                  return i.nh.pop(t).then(function (t) {
                    i.sh(t);
                  });
                }, 'pop');
              }),
              ...
              (i.replaceStateForTarget = function (t) {
                var i = this;
                Zt('#' == t[0]);
                var n = this.Ze.win.location.hash;
                return this.push(function () {
                  i.Ze.win.location.replace(n || '#');
                }).then(function () {
                  i.nh.replaceStateForTarget(t);
                });
              }),
              (i.getFragment = function () {
                return this.nh.getFragment();
              }),
              (i.updateFragment = function (t) {
                return (
                  '#' == t[0] && (t = t.substr(1)), this.nh.updateFragment(t)
                );
              }),
              (i.sh = function (t) {
                (this.rh = t.stackIndex), this.uh(t);
              }),
              (i.uh = function (t) {
                var i = this;
                if (!(this.rh >= this.eh.length - 1)) {
                  for (var n = [], r = this.eh.length - 1; r > this.rh; r--)
                    this.eh[r] && (n.push(this.eh[r]), (this.eh[r] = void 0));
                  if ((this.eh.splice(this.rh + 1), n.length > 0))
                    for (
                      var e = function (r) {
                          i.iu.delay(function () {
                            return n[r](t);
          ...
          ch = (function () {
            function t(t) {
              var i = this;
              (this.win = t), (this.iu = fr(t));
              var n = this.win.history;
              this.ah = n.length - 1;
              var r,
                e,
                s = uh(n);
              s && void 0 !== s[hh] && (this.ah = Math.min(s[hh], this.ah)),
                (this.rh = this.ah),
                this.fh,
                (this.sh = null),
                (this.lh = 'state' in n),
                (this.dh = this.mh(this.rh)),
                n.pushState && n.replaceState
                  ? ((this.ph = n.originalPushState || n.pushState.bind(n)),
                    (this.bh =
                    ...
                    (e = function (t, n, r) {
                      i.dh = t;
                      try {
                        void 0 !== r ? i.bh(t, n, r) : i.bh(t, n);
                      } catch (t) {
                        Qt().error(oh, 'replaceState failed: ' + t.message);
                      }
                    }),
                    n.originalPushState || (n.originalPushState = this.ph),
                    n.originalReplaceState ||
                      (n.originalReplaceState = this.bh))
                  : ((r = function (t, n, r) {
                      i.dh = t;
                    }),
                    (e = function (t, n, r) {
                ...
                (this.yh = e);
              try {
                this.yh(this.mh(this.rh, !0));
              } catch (t) {
                Qt().error(oh, 'Initial replaceState failed: ' + t.message);
              }
              (n.pushState = this.wh.bind(this)),
                (n.replaceState = this.Ah.bind(this)),
                (this.xh = function (t) {
                  var n = t.state;
                  Qt().fine(
                    oh,
                ...
                this.win.addEventListener('popstate', this.xh);
            }
            var i = t.prototype;
            return (
              (i.cleanup = function () {
                this.ph && (this.win.history.pushState = this.ph),
                  this.bh && (this.win.history.replaceState = this.bh),
                  this.win.removeEventListener('popstate', this.xh);
              }),
              (i.mh = function (t, i) {
                var n = A(i ? this.Oh() : void 0);
                return (n[hh] = t), n;
              }),
              ...
              (i.push = function (t) {
                var i = this;
                return this.Th(function () {
                  var n = i.Ph(i.Oh(), t || {});
                  return (
                    i.wh(n, void 0, n.fragment ? '#' + n.fragment : void 0),
                    c(function () {
                      return i.Ph(n, { stackIndex: i.rh });
                    })
                  );
                });
              }),
              (i.pop = function (t) {
                var i = this;
                return (
                  (t = Math.max(t, this.ah)),
                  this.Th(function () {
                    return i.Ih(i.rh - t + 1);
                  }).then(function (t) {
                    return i.Ph(i.Oh(), { stackIndex: t });
                  })
                );
              }),
              (i.replace = function () {
                ...
                return this.Th(function () {
                  ...
                  return (
                    t.Ah(n, n.title, r || e ? r + e : void 0),
                    c(function () {
                      return t.Ph(n, { stackIndex: t.rh });
                    })
                  );
                });
              }),
              (i.get = function () {
                var t = this;
                return c(function () {
                  return t.Ph(t.Oh(), { stackIndex: t.rh });
                });
              }),
              (i.backTo = function (t) {
                var i = this;
              ...
              (i.Eh = function () {
                ...
                (this.fh = void 0),
                  n > this.win.history.length - 2 &&
                    ((n = this.win.history.length - 2),
                    this.Sh(this.Ph(t, { stackIndex: n }))),
                  null == i
                    ? (n += 1)
                    : (n =
                  ...
                  t || (t = {}),
                  (t[hh] = n),
                  this.yh(t, void 0, void 0),
                  n != this.rh && this.Sh(this.Ph(t, { stackIndex: n })),
                  n < this.ah && (this.ah = n),
                  r && r.resolve();
              }),
              (i.Oh = function () {
                return this.lh ? uh(this.win.history) : this.dh;
              }),
              (i.Mh = function () {
                Zt(!this.fh);
              }),
              (i.Th = function (t) {
                return this.fh ? this.fh.promise.then(t, t) : t();
              }),
              (i.Rh = function () {
                this.Mh();
                var t = new a(),
                  i = t.reject,
                  n = t.resolve,
                  r = this.iu.timeoutPromise(500, t.promise);
                return (this.fh = { promise: r, resolve: n, reject: i }), r;
              }),
              (i.Ih = function (t) {
                var i = this;
                if ((this.Mh(), t <= 0)) return Promise.resolve(this.rh);
                this.dh = this.mh(this.rh - t);
                var n = this.Rh();
                return (
                  this.win.history.go(-t),
                  n.then(function () {
                    return Promise.resolve(i.rh);
                  })
                );
              }),
              (i.wh = function (t, i, n) {
              ...
              (i.replaceStateForTarget = function (t) {
                ...
                Zt('#' == t[0]),
                  this.Th(function () {
                    i.win.removeEventListener('popstate', i.xh);
                    try {
                      i.win.location.replace(t);
                    } finally {
                      i.win.addEventListener('popstate', i.xh);
                    }
                    return i.Ah(), h();
                  });
              }),
              (i.Ah = function (t, i, n) {
                this.Mh(), t || (t = {});
                var r = Math.min(this.rh, this.win.history.length - 1);
                (t[hh] = r), this.yh(t, i, n);
                var e = this.Ph(t, { stackIndex: r });
                this.Sh(e);
              }),
              (i.Sh = function (t) {
                this.Mh(),
                  ...
                  this.rh != t.stackIndex &&
                    (Qt().fine(
                      oh,
                      'stack index changed: ' + this.rh + ' -> ' + t.stackIndex
                    ),
                    (this.rh = t.stackIndex),
                    this.sh && this.sh(t));
              }),
          ...
          fh = (function () {
            function t(t, i) {
              ...
              (this.win = t),
                ...
                (this.rh = 0),
                (this.sh = null),
                (this._h = this.Mu.onMessage('historyPopped', function (t) {
                  return n.kh(t);
                }));
            }
            var i = t.prototype;
            return (
              ...
              (i.push = function (t) {
                var i = this,
                  n = D({ stackIndex: this.rh + 1 }, t || {}),
                  r = 'pushHistory';
                return this.Mu.sendMessageAwaitResponse(r, n).then(function (
                  t
                ) {
                  var e = n,
                    s = i.Nh(t, e, r);
              ...
              (i.pop = function (t) {
                var i = this;
                if (t > this.rh) return this.get();
                var n = { stackIndex: this.rh },
                  r = 'popHistory';
                return this.Mu.sendMessageAwaitResponse(r, n).then(function (
                  t
                ) {
                  var n = { stackIndex: i.rh - 1 },
                    e = i.Nh(t, n, r);
                  return i.Sh(e), e;
                });
              }),
              (i.replace = function (t) {
                var i = this;
                if (t && t.url) {
                  if (!this.Mu.hasCapability('fullReplaceHistory')) {
                    var n = { stackIndex: this.rh };
                ...
                var e = D({ stackIndex: this.rh }, t || {}),
                  s = 'replaceHistory';
                return this.Mu.sendMessageAwaitResponse(s, e, !0).then(
                  function (t) {
                    var n = e,
                      r = i.Nh(t, n, s);
                    return i.Sh(r), r;
              ...
              (i.Sh = function (t) {
                ...
                this.rh != i &&
                  (Qt().fine(
                    oh,
                    'stackIndex: '.concat(this.rh, ' -> ').concat(i)
                  ),
                  (this.rh = i),
                  this.sh && this.sh(t));
              }),
              (i.getFragment = function () {
                return this.Mu.hasCapability('fragment')
                  ? this.Mu.sendMessageAwaitResponse(
                      'getFragment',
                      void 0,
                      !0
                    ).then(function (t) {
            ...
            return (
              ...
              (i.jh = function (t) {
                var i = t.boundingClientRect,
                  ...
                  h = this.Uh.get(u);
                o !== ((h && h.shown) || !1) &&
                  (o && !h && ((h = this.Lh(u, s, e)), this.Uh.set(u, h)),
                  h &&
                    ((h.shown = o),
              ...
              (i.zh = function (t) {
                var i = this.Uh.get(t);
                i && (this.Uh.delete(t), Mi(i.container));
              }),
              t
            );
          })(),
          ph = (function () {
            function t(t, i) {
              ...
              (this.win = t),
                ...
                (this.Vh = new Or()),
                (this.Fh = function (t) {
                  K(t.target) && n.Bh(t.target);
                }),
                (this.qh = function (i) {
                  fr(t).delay(function () {
                    n.win.document.activeElement &&
                      n.Bh(n.win.document.activeElement);
                  }, 500);
                }),
                this.win.document.addEventListener('focus', this.Fh, !0),
                this.win.addEventListener('blur', this.qh);
            }
            var i = t.prototype;
            return (
              (i.zh = function () {
                this.win.document.removeEventListener('focus', this.Fh, !0),
                  this.win.removeEventListener('blur', this.qh);
              }),
              (i.onFocus = function (t) {
                return this.Vh.add(t);
              }),
              (i.Bh = function (t) {
                var i = Date.now();
                0 == this.Gh.length || this.Gh[this.Gh.length - 1].el != t
                  ? this.Gh.push({ el: t, time: i })
                  : (this.Gh[this.Gh.length - 1].time = i),
                  this.purgeBefore(i - this.Hh),
                  this.Vh.fire(t);
              }),
              (i.getLast = function () {
                return 0 == this.Gh.length
                  ? null
                  : this.Gh[this.Gh.length - 1].el;
              }),
              (i.purgeBefore = function (t) {
                for (var i = this.Gh.length - 1, n = 0; n < this.Gh.length; n++)
                  if (this.Gh[n].time >= t) {
                    i = n - 1;
                    break;
                  }
                -1 != i && this.Gh.splice(0, i + 1);
              }),
              (i.hasDescendantsOf = function (t) {
                this.win.document.activeElement &&
                  this.Bh(this.win.document.activeElement);
                for (var i = 0; i < this.Gh.length; i++)
                  if (t.contains(this.Gh[i].el)) return !0;
                return !1;
              }),
              t
            );
          ...
          bh = (function () {
            function t(t) {
              ...
              (this.ampdoc = t),
                (this.win = t.win),
                (this._e = ar(t)),
                (this.$h = gr(this.ampdoc)),
                (this.Wh = pr(this.win)),
                (this.Kh = new ph(this.win, 6e4)),
                this.Kh.onFocus(function (t) {
                  i.Yh(t);
                });
            }
            var i = t.prototype;
            return (
              ...
              (i.collapseElement = function (t) {
                var i = this.$h.getLayoutRect(t);
                0 != i.width &&
                  0 != i.height &&
                  (Fe(this.win, 'dirty-collapse-element')
                    ? this.dirtyElement(t)
                    : this._e.setRelayoutTop(i.top)),
                  Vs.forElement(t).completeCollapse(),
                  this._e.schedulePass(gh);
              }),
              (i.measureElement = function (t) {
                return this.Wh.measurePromise(t);
              }),
              (i.mutateElement = function (t, i, n) {
                return this.Xh(t, null, i, n);
              }),
              (i.measureMutateElement = function (t, i, n) {
                return this.Xh(t, i, n);
              }),
              (i.Qh = function (t) {
              ...
              (i.Xh = function (t, i, n) {
                var r = this,
                  e =
                    ...
                    arguments[3],
                  s = function () {
                    var i = r.$h.getLayoutRect(t);
                    return 0 != i.width && 0 != i.height ? i.top : -1;
                  },
                  u = -1;
                return this.Wh.runPromise({
                  measure: function () {
                    i && i(), e || (u = s());
                  },
                  mutate: function () {
                    if ((n(), !e)) {
                      ...
                      r._e.schedulePass(gh),
                        -1 != u && r._e.setRelayoutTop(u),
                        r.Wh.measure(function () {
                          var t = s();
                          -1 != t &&
                            t != u &&
                            (r._e.setRelayoutTop(t), r._e.schedulePass(gh)),
                            r._e.maybeHeightChanged();
                        });
                    }
                  },
                });
              ...
              (i.dirtyElement = function (t) {
                ...
                if (t.classList.contains('i-amphtml-element')) {
                  ...
                  this._e.setRelayoutTop(n.getLayoutBox().top);
                } else i = !0;
                this._e.schedulePass(gh, i);
              }),
              (i.Yh = function (t) {
                ...
                if (i) {
                  ...
                  void 0 !== r &&
                    this.Jh(n, r.height, r.width, r.margins, void 0, !0);
                }
              }),
              (i.Jh = function (t, i, n, r, e, s, u) {
                var o = this;
                t.hasBeenMeasured() && !r
                  ? this.Zh(t, i, n, void 0, e, s, u)
                  : this.Wh.measure(function () {
                      t.hasBeenMeasured() || t.measure();
                      var h = r
                        ? { newMargins: r, currentMargins: o.Qh(t) }
                        : void 0;
                      o.Zh(t, i, n, h, e, s, u);
                    });
              }),
              (i.Zh = function (t, i, n, r, e, s, u) {
                ...
                this._e.updateOrEnqueueMutateTask(t, {
                  resource: t,
                  newHeight: i,
                  newWidth: n,
                  marginChange: r,
          ...
          Sh = (function () {
            function t(t) {
              ...
              (this.ampdoc = t),
                ...
                (this.$h = gr(this.ampdoc)),
                (this.Mu = mr(this.ampdoc)),
                (this.Gh = rr(this.ampdoc)),
                (this.ia = or(this.ampdoc.win)),
                (this.na = this.ia.isIos() && this.ia.isSafari()),
                (this.ra = Ni(this.ampdoc.win) && this.Mu.isOvertakeHistory()),
                (this.ea =
                  this.ta != this.ampdoc.getRootNode() ||
                  !!this.ampdoc.getParent()),
                (this.sa = 'inabox' == Dt(this.ampdoc.win).runtime),
                (this.oa =
                  this.ta.nodeType == Node.DOCUMENT_NODE
                    ? this.ta.documentElement
                    : this.ta),
                (this.ua = this.ha.bind(this)),
                this.ta.addEventListener(Oh, this.ua),
                this.ta.addEventListener(Ih, this.ua),
                (this.aa = !1),
                (function (t) {
                ...
                Promise.all([
                  this.Mu.isTrustedViewer(),
                  this.Mu.getViewerOrigin(),
                ]).then(function (t) {
                  var n;
                  (i.ca = t[0]), (i.fa = ((n = t[1]), Mt.test(ds(n).origin)));
                }),
                (this.la = null),
                (this.va = new Ys()),
                (this.da = new Ys());
            ...
            return (
              (i.cleanup = function () {
                this.ua &&
                  (this.ta.removeEventListener(Oh, this.ua),
                  this.ta.removeEventListener(Ih, this.ua));
              }),
              (i.openWindow = function (t, i, n, r) {
                var e = '';
                (!this.ia.isIos() && this.ia.isChrome()) ||
                  r ||
                  (e += 'noopener');
                var s = Eh(t, i, n, e);
                s && !r && (s.opener = null);
              ...
              (i.navigateToAmpUrl = function (t, i) {
                return (
                  !!this.Mu.hasCapability('a2a') &&
                  (this.Mu.sendMessage('a2aNavigate', {
                    url: t,
                    requestedBy: i,
                  }),
                  !0)
              ...
              (i.ha = function (t) {
                if (!t.defaultPrevented) {
                  ...
                  i &&
                    ...
                    (t.type == Oh
                      ? this.ba(i, t)
                      : t.type == Ih && this.ga(i, t));
                }
              }),
              (i.ba = function (t, i) {
                this.ya(t);
                var n = this.wa(t.href);
                if (!this.Aa(i, t, n) && !this.xa(i, t, n)) {
                  var r = this.Ea();
                  _h(n) != _h(r) && (this.Oa(t, i), (n = this.wa(t.href))),
                    this.Ta(i, t, n, r);
                }
              }),
              (i.ga = function (t, i) {
                this.ya(t), this.Oa(t, i);
              }),
              (i.Oa = function (t, i) {
                this.va.forEach(function (n) {
                  n(t, i);
                });
              }),
              (i.ma = function (t) {
                return (
                  this.da.forEach(function (i) {
                    t = i(t);
                  }),
                  t
                );
              ...
              (i.Ta = function (t, i, n, r) {
                var e = _h(n),
                  s = _h(r);
                if (n.hash && e == s) this.Pa(t, n, r);
                else {
              ...
              (i.Pa = function (t, i, n) {
                var r = this;
                if ((t.preventDefault(), !this.ea)) {
                  var e = i.hash.slice(1),
                    s = null;
                  if (e) {
                    var u = vi(e);
                    s =
                      this.ta.getElementById(e) ||
                      this.ta.querySelector('a[name="'.concat(u, '"]'));
                  }
                  i.hash != n.hash
                    ? this.Gh.replaceStateForTarget(i.hash).then(function () {
                        r.Sa(s, e);
                      })
                    : this.Sa(s, e);
                }
              ...
              (i.Sa = function (t, i) {
                var n = this;
                t
                  ? (this.$h.scrollIntoView(t),
                    fr(this.ampdoc.win).delay(function () {
                      return n.$h.scrollIntoView(t);
                    }, 1))
                  : Qt().warn(
                      Ph,
              ...
              (i.wa = function (t) {
                return dr(this.oa).parse(t);
              }),
              (i.Ea = function () {
                return this.wa('');
              }),
              (i.viewerInterceptsNavigation = function (t, i) {
                var n = this.Mu.hasCapability('interceptNavigation'),
                  r =
                ...
                return !(
                  ...
                  !r ||
                  (!this.ca && !this.fa) ||
                  (this.Mu.sendMessage('navigateTo', {
                    url: t,
                    requestedBy: i,
                  }),
                  0)
        ...
        var Ch = (function () {
            ...
            return (
              ...
              (i.schedulePreload = function (t, i) {
                this.Ma(this._e.getResourceForElement(t), !1, kh(i));
              }),
              (i.scheduleLayout = function (t, i) {
                this.Ma(this._e.getResourceForElement(t), !0, kh(i));
              }),
              (i.schedulePause = function (t, i) {
                var n = this._e.getResourceForElement(t);
                (i = kh(i)),
                  this.Ra(n, i, function (t) {
                    t.pause();
                  });
              }),
              ...
              (i.Ra = function (t, i, n) {
                for (var r, e = o(i, !0); !(r = e()).done; ) {
                  var s = r.value;
                  Zt(t.element.contains(s)), this._a(s, n);
                }
              }),
              (i._a = function (t, i) {
                if (t.classList.contains('i-amphtml-element')) {
                  i(this._e.getResourceForElement(t));
                  ...
                  for (
                    ...
                    o || (e.push(u), i(this._e.getResourceForElement(u)));
                  }
              }),
              (i.Ma = function (t, i, n) {
                this.Ra(t, n, function (i) {
          ...
          Nh = (function () {
            function t(t) {
              (this.ka = t.navigator), (this.t = t);
            }
            var i = t.prototype;
            return (
              (i.isAndroid = function () {
                return /Android/i.test(this.ka.userAgent);
              }),
              (i.isIos = function () {
                return /iPhone|iPad|iPod/i.test(this.ka.userAgent);
              }),
              (i.isSafari = function () {
                return (
                  /Safari/i.test(this.ka.userAgent) &&
                  !this.isChrome() &&
                  !this.isEdge() &&
                  !this.isFirefox() &&
                  !this.isOpera()
              ...
              (i.isChrome = function () {
                return (
                  /Chrome|CriOS/i.test(this.ka.userAgent) &&
                  !this.isEdge() &&
                  !this.isOpera()
                );
              }),
              (i.isFirefox = function () {
                return (
                  /Firefox|FxiOS/i.test(this.ka.userAgent) && !this.isEdge()
                );
              }),
              (i.isOpera = function () {
                return /OPR\/|Opera|OPiOS/i.test(this.ka.userAgent);
              }),
              (i.isEdge = function () {
                return /Edge/i.test(this.ka.userAgent);
              }),
              (i.isWebKit = function () {
                return /WebKit/i.test(this.ka.userAgent) && !this.isEdge();
              }),
              (i.isWindows = function () {
                return /Windows/i.test(this.ka.userAgent);
              }),
              (i.isStandalone = function () {
                return (
                  (this.isIos() && this.ka.standalone) ||
                  (this.isChrome() &&
                    this.t.matchMedia('(display-mode: standalone)').matches)
                );
              }),
              (i.isBot = function () {
                return /bot/i.test(this.ka.userAgent);
              }),
              (i.getMajorVersion = function () {
                return this.isSafari()
                  ? this.isIos()
                    ? this.getIosMajorVersion() || 0
                    : this.Na(/\sVersion\/(\d+)/, 1)
                  : this.isChrome()
                  ? this.Na(/(Chrome|CriOS)\/(\d+)/, 2)
                  : this.isFirefox()
                  ? this.Na(/(Firefox|FxiOS)\/(\d+)/, 2)
                  : this.isOpera()
                  ? this.Na(/(OPR|Opera|OPiOS)\/(\d+)/, 2)
                  : this.isEdge()
                  ? this.Na(/Edge\/(\d+)/, 1)
                  : 0;
              }),
              (i.Na = function (t, i) {
                if (!this.ka.userAgent) return 0;
                var n = this.ka.userAgent.match(t);
        ...
        var jh = (function () {
          ...
          Uh = (function () {
            function t() {
              (this.Fs = []), (this.Da = {}), (this.Ua = 0), (this.za = 0);
            }
            var i = t.prototype;
            return (
              (i.getSize = function () {
              ...
              (i.dequeue = function (t) {
                var i = this.Da[t.id];
                return (
                  !!this.removeAtIndex(t, this.Fs.indexOf(i)) &&
                  ((this.za = Date.now()), !0)
                );
              }),
              (i.peek = function (t) {
                for (var i = 1e6, n = null, r = 0; r < this.Fs.length; r++) {
                  var e = this.Fs[r],
                    s = t(e);
                  s < i && ((i = s), (n = e));
                }
              ...
              (i.removeAtIndex = function (t, i) {
                ...
                return !(
                  !n ||
                  this.Fs[i] != n ||
                  (this.Fs.splice(i, 1), delete this.Da[t.id], 0)
                );
              }),
              (i.purge = function (t) {
                for (var i = this.Fs.length; i--; )
                  t(this.Fs[i]) && this.removeAtIndex(this.Fs[i], i);
              }),
              t
            );
          })(),
          ...
          zh = (function () {
            function t(t) {
              ...
              (this.ampdoc = t),
                ...
                (this.Qa = 0),
                (this.Za = 0),
                (this.hu = new Uu(this.win, function () {
                  return i.doPass();
                })),
                (this.tc = new Uu(this.win, function () {
                  (i.Ja = !0), i.schedulePass();
                })),
                (this.ic = new Uh()),
                (this._s = new Uh()),
                (this.nc = this.rc.bind(this)),
                (this.ec = []),
                (this.sc = []),
                (this.oc = !1),
                (this.$h = gr(this.ampdoc)),
                ...
                (this.fc = []),
                (this.lc = new a()),
                (this.vc = new jh(this.ampdoc.getVisibilityState())),
                this.$h.onChanged(function (t) {
                  (i.Qa = i.win.Date.now()),
                    (i.Za = t.velocity),
                    t.relayoutAll && ((i.Ja = !0), (i.ac = !0)),
                    i.schedulePass();
                }),
                ...
                this.Mu.onRuntimeState(function (t) {
                  Qt().fine(Lh, 'Runtime state:', t),
                    (i.La = t),
                    i.schedulePass(1);
                }),
                Zs(this.ampdoc, function () {
                  i.dc(i.vc), i.schedulePass(0);
                }),
                this.mc(),
                (this.bc = dt(
                  this.win,
                ...
                Je(this.win.document, 'scroll', this.bc, {
                  capture: !0,
                  passive: !0,
                });
            }
            ...
            return (
                ...
                if (r) {
                  ...
                  s ||
                    ...
                    (this.$a
                      ...
                      : t.isBuilt() ||
                        t.isBuilding() ||
                        (i && this.sc.includes(t)) ||
                        (this.sc.push(t), this.yc()));
                }
              }),
              (i.yc = function () {
                if (!this.oc)
              ...
              (i.Ec = function () {
                for (var t = 0; t < this.sc.length; t++) {
                  var i = this.sc[t];
                  (this.$a || ki(i.element, this.ampdoc.getRootNode())) &&
                    (this.sc.splice(t--, 1), this.xc(i));
                }
              }),
              (i.xc = function (t) {
                var i = this,
                  n =
                    ...
                    void 0 !== arguments[1] &&
                    arguments[1];
                if (!n && !this.wc() && !t.isBuildRenderBlocking()) return null;
                var r = t.build();
                return r
              ...
              (i.upgraded = function (t) {
                ...
                this.Ac(i), Qt().fine(Lh, 'resource upgraded:', i.debugid);
              }),
              (i.updateLayoutPriority = function (t, i) {
                var n = Vs.forElement(t);
                n.updateLayoutPriority(i),
                  this._s.forEach(function (t) {
                    t.resource == n && (t.priority = i);
                  }),
                  this.schedulePass();
              }),
              (i.schedulePass = function (t) {
                return this.hu.schedule(t);
              }),
              (i.updateOrEnqueueMutateTask = function (t, i) {
                for (var n = null, r = 0; r < this.ec.length; r++)
                  if (this.ec[r].resource == t) {
                    n = this.ec[r];
                    break;
                  }
                n
                ...
                if (this.La) {
                  if (
                    ...
                    this.Mu.sendMessage(
                      ...
                      (this.hc = this.$h.getContentHeight()),
                      this.Mu.sendMessage(
                        'documentHeight',
                        { height: this.hc },
                        !0
                      ),
                      Qt().fine(Lh, 'document height on load: %s', this.hc);
                  }
                  !this.Wa &&
                    this.Pc &&
                    this._e.every(function (t) {
                  ...
                  Qt().fine(
                    ...
                    this.hu.cancel(),
                    (this.uc = !1),
                    this.vc.setState(this.ampdoc.getVisibilityState()),
                    this.Ic(),
                    this.ac &&
                      ((this.ac = !1),
                      this.Wh.measure(function () {
                        var i = t.$h.getContentHeight();
                        i != t.hc &&
                          (t.Mu.sendMessage(
                            'documentHeight',
                            { height: i },
                          ...
                          (t.hc = i),
                          Qt().fine(Lh, 'document height changed: %s', t.hc),
                          t.$h.contentHeightChanged());
                      }));
                  for (var s = 0; s < this.cc.length; s++) (0, this.cc[s])();
                  this.cc.length = 0;
              ...
              (i.Mc = function () {
                var t = this,
                  ...
                  e = n.height / 10,
                  s =
                    (Math.abs(this.Za) < 0.01 && i - this.Qa > 500) ||
                    i - this.Qa > 1e3;
                if (this.ec.length > 0) {
                  Qt().fine(Lh, 'change size requests:', this.ec.length);
                  var u = this.ec;
                  this.ec = [];
                  for (
                    var o = -1,
                      ...
                      c = function (i) {
                        ...
                        else if (c.force || !t.qa) O = !0;
                        else if (
                          t.Kh.hasDescendantsOf(v.element) ||
                          (l &&
                            l.userActivation &&
                  ...
                  -1 != o && this.setRelayoutTop(o),
                    h.length > 0 &&
                      this.Wh.run(
                        {
                          measure: function (i) {
                            (i.scrollHeight = t.$h.getScrollHeight()),
                              (i.scrollTop = t.$h.getScrollTop());
                          },
                          mutate: function (i) {
                            var n = -1;
              ...
              (i.Nc = function () {
                var t = this.win.Date.now(),
                  ...
                  r = this.Xa;
                (this.Ja = !1), (this.Xa = -1);
                for (var e, s = 0, u = 0, o = 0; o < this._e.length; o++) {
                  var h = this._e[o];
                  0 != h.getState() ||
                    h.isBuilding() ||
                    h.element.R1() ||
                ...
                if (s > 0 || u > 0 || n || -1 != r || i.length > 0)
                  for (var a = 0; a < this._e.length; a++) {
                    var c = this._e[a];
                    if (
                      !(
                      ...
                      f && (this._c(c) || (e || (e = []), e.push(c)));
                    }
                  }
                (i.length = 0), e && this.kc(e);
                var v,
                  d = this.$h.getRect();
                v = this.qa ? Hi(d, 0.25, 2) : d;
                for (
                  var m = this.qa ? Hi(d, 0.25, 0.25) : d, p = 0;
                  p < this._e.length;
                  p++
                ) {
                  var g = this._e[p];
                  if (0 != g.getState() && !g.hasOwner() && !g.element.R1()) {
                    var b = this.qa && g.isDisplayed() && g.overlaps(m);
                    g.setInViewport(b);
                  }
                }
                if (v)
                  for (var y = 0; y < this._e.length; y++) {
                    var w = this._e[y];
                    w.isBuilt() ||
                      w.isBuilding() ||
                      w.hasOwner() ||
                ...
                if (this.qa && this.Cc(t)) {
                  for (var A = 0, x = 0; x < this._e.length && A < 4; x++) {
                    var E = this._e[x];
                    2 == E.getState() &&
                      !E.hasOwner() &&
                      !E.element.R1() &&
                  ...
                  for (var P = 0; P < this._e.length && A < 4; P++) {
                    var O = this._e[P];
                    2 != O.getState() ||
                      O.hasOwner() ||
                      O.element.R1() ||
              ...
              (i.jc = function () {
                for (
                  ...
                  this._s.dequeue(n);
                  var r = this.ic.getTaskById(n.id);
                  if (r) {
                    var e = this.Uc.bind(this, n);
                    r.promise.then(e, e);
                  } else {
                    var s = n.resource;
                    s.measure(),
                      this.zc(s, n.forceOutsideViewport)
                        ? ((n.promise = n.callback()),
                          ...
                          n.promise
                            .then(
                              this.Lc.bind(this, n, !0),
                              this.Lc.bind(this, n, !1)
                            )
                            .catch(Us))
                        : (Qt().fine(Lh, 'cancelled', n.id),
                          s.layoutCanceled());
                  }
                  (n = this._s.peek(this.nc)), (i = -1);
                }
                if (
                  (Qt().fine(
                    Lh,
                  ...
                  return i;
                var u = 2 * (t - this.ic.getLastDequeueTime());
                return Math.max(Math.min(3e4, u), 5e3);
              }),
              (i.rc = function (t) {
                var i = this.$h.getRect(),
              ...
              (i.Dc = function (t) {
                ...
                if (0 == this.ic.getSize()) {
                  if (-1 === this.Ya) return 0;
                  var n = 1e3 * t.priority;
                  return Math.max(n - (i - this.Ya), 0);
                }
                var r = 0;
                return (
                  this.ic.forEach(function (n) {
              ...
              (i.Uc = function (t) {
                this._s.getTaskById(t.id) || this._s.enqueue(t);
              }),
              (i.Lc = function (t, i, n) {
                if ((this.ic.dequeue(t), this.schedulePass(1e3), !i))
                  return (
              ...
              (i.scheduleLayoutOrPreload = function (t, i, n, r) {
                if (!t.element.R1()) {
                  ...
                  this.zc(t, u) &&
                    (i
                      ? this.Ys(t, 'L', 0, n || 0, u, t.startLayout.bind(t))
                      : this.Ys(t, 'P', 2, n || 0, u, t.startLayout.bind(t)));
                }
              }),
              (i.Ys = function (t, i, n, r, e, s) {
                var u = t.getTaskId(i),
                  o = {
                    id: u,
                    resource: t,
                ...
                var h = this._s.getTaskById(u);
                (!h || o.priority < h.priority) &&
                  (h && this._s.dequeue(h),
                  this._s.enqueue(o),
                  this.schedulePass(this.Dc(o))),
              ...
              (i.Tc = function (t, i) {
                if (
                  ((1 != t.getState() && 2 != t.getState()) ||
                    (this._s.purge(function (i) {
                      return i.resource == t;
                    }),
                    this.ic.purge(function (i) {
                      return i.resource == t;
                    }),
                    B(this.ec, function (i) {
                      return i.resource === t;
                    })),
                  0 == t.getState() && i && this.sc)
                ) {
                  var n = this.sc.indexOf(t);
                  -1 != n && this.sc.splice(n, 1);
                }
              }),
              (i.gc = function (t) {
                var i = t.target;
                if (
                  ...
                  i !== this.$h.getScrollingElement()
                ) {
                  var n = i;
                  this.fc.includes(n) ||
                    (this.fc.push(n), this.schedulePass(70));
                }
              }),
              t
            );
        ...
        var Vh = 'STANDARD-ACTIONS',
          ...
          Bh = (function () {
            function t(t) {
              this.ampdoc = t;
              var i = t.getHeadNode();
              (this.Gc = sr(t)), (this.$h = gr(t)), this.Vc(Wn(i)), this.Fc();
            }
            var i = t.prototype;
            return (
              (i.Vc = function (t) {
                t.addGlobalTarget('AMP', this.Bc.bind(this)),
                  t.addGlobalMethodHandler('hide', this.qc.bind(this)),
                  t.addGlobalMethodHandler('show', this.$c.bind(this)),
                  t.addGlobalMethodHandler(
                    'toggleVisibility',
                    this.Wc.bind(this)
                  ),
                  t.addGlobalMethodHandler('scrollTo', this.Kc.bind(this)),
                  t.addGlobalMethodHandler('focus', this.Yc.bind(this)),
                  t.addGlobalMethodHandler('toggleClass', this.Jc.bind(this)),
                  t.addGlobalMethodHandler('copy', this.Xc.bind(this)),
                  t.addGlobalMethodHandler('toggleChecked', this.Qc.bind(this));
              }),
              (i.Fc = function () {
                this.Zc() &&
              ...
              (i.Kc = function (t) {
                ...
                return (
                  ...
                  J(e) || (e = void 0),
                  this.$h.animateScrollIntoView(i, r, e)
                );
              }),
              (i.Yc = function (t) {
              ...
              (i.qc = function (t) {
                ...
                if (i.classList.contains('i-amphtml-element')) {
                  ...
                  this.Gc.mutateElement(i, function () {
                    return Nr(i, !1);
                  });
                return null;
              }),
              (i.$c = function (t) {
                ...
                this.Gc.measureElement(function () {
                  'none' != jr(r, n).display ||
                    Gh(n) ||
                    Jt().warn(
                      Vh,
                ...
                return (
                  s && or(r).isIos()
                    ? (this.rf(n, s), this.Gc.mutateElement(n, function () {}))
                    : this.Gc.mutateElement(n, function () {
                        i.rf(n, s);
                      }),
                  null
                );
              ...
              (i.Wc = function (t) {
                return Gh(t.node) ? this.$c(t) : this.qc(t);
              }),
              (i.Jc = function (t) {
                var i = t.node,
                  n = t.args,
          ...
          $h = (function () {
            ...
            return (
              ...
              (i.get = function (t, i) {
                return this.af().then(function (n) {
                  return n.get(t, i);
                });
              }),
              ...
              (i.setNonBoolean = function (t, i, n) {
                return this.cf(function (r) {
                  return r.set(t, i, n);
                });
              }),
              (i.remove = function (t) {
                return this.cf(function (i) {
                  return i.remove(t);
                });
              }),
              ...
              (i.cf = function (t) {
                ...
                return this.af()
                  .then(function (n) {
                    ...
                    return i.nh.saveBlob(i.i, r);
                  })
                  .then(this.ff.bind(this));
              }),
              (i.hf = function () {
                var t = this;
                this.Mu.onBroadcast(function (i) {
                  'amp-storage-reset' == i.type &&
                    i.origin == t.i &&
                    (Qt().fine(qh, 'Received reset message'), (t.sf = null));
                });
              }),
              (i.ff = function () {
          ...
          Wh = (function () {
            function t(t, i) {
              (this.obj = E(t)),
                (this.lf = i || 8),
                (this.vf = this.obj.vv || Object.create(null)),
                this.obj.vv || (this.obj.vv = this.vf);
            }
            var i = t.prototype;
            return (
              (i.get = function (t, i) {
              ...
              (i.set = function (t, i, n) {
                if (
                  ...
                  var r = this.vf[t],
                    e = Date.now();
                  n && (e = r.t), (r.v = i), (r.t = e);
                } else this.vf[t] = { v: i, t: Date.now() };
                var s = Object.keys(this.vf);
                if (s.length > this.lf) {
          ...
          Yh = (function () {
            function t(t) {
              if (((this.win = t), (this.df = this.mf()), !this.df)) {
            ...
            return (
              ...
              (i.loadBlob = function (t) {
                ...
                return new Promise(function (n) {
                  i.df ? n(i.win.localStorage.getItem(i.pf(t))) : n(null);
                });
              }),
              (i.saveBlob = function (t, i) {
                var n = this;
                return new Promise(function (r) {
                  n.df ? (n.win.localStorage.setItem(n.pf(t), i), r()) : r();
                });
              }),
              t
            );
          ...
          Kh = (function () {
            ...
            return (
              (i.loadBlob = function (t) {
                return this.Mu.sendMessageAwaitResponse('loadStore', {
                  origin: t,
                }).then(function (t) {
                  return t.blob;
                });
              ...
              (i.saveBlob = function (t, i) {
                return this.Mu.sendMessageAwaitResponse('saveStore', {
                  origin: t,
                  blob: i,
                }).catch(function (t) {
          ...
          Qh = (function () {
            function t(t) {
              (this.Ze = t), (this.bf = {}), (this.gf = {});
            }
            var i = t.prototype;
            return (
              (i.whenReady = function (t) {
                return this.yf(t).then(Xh);
              }),
              (i.setHtmlForTemplate = function (t, i) {
                var n = this;
                return this.yf(t).then(function (t) {
                  return n.wf(t, i);
                });
              }),
              ...
              (i.yf = function (t) {
                ...
                return (
                  s ||
                  ((s = this.Af(t, r).then(function (n) {
                    var r = n,
                      e = (t[Jh] = new r(t, i.Ze.win));
              ...
              (i.Af = function (t, i) {
                if (this.bf[i]) return this.bf[i];
                var n = new a(),
                  r = n.promise,
                  e = n.resolve;
                return (this.bf[i] = r), (this.gf[i] = e), r;
              }),
              (i.xf = function (t, i) {
                if (this.bf[t]) {
                  var n = this.gf[t];
                  ti(n, 'Duplicate template type: %s', t),
                    delete this.gf[t],
                    n(i);
                } else this.bf[t] = Promise.resolve(i);
              }),
              (i.Bi = function (t, i) {
                return t.render(i);
              }),
          ...
          Zh = (function () {
            function t(t) {
              (this.win = t),
                (this.Ef = this.win.Promise.resolve()),
                (this.Of = 0),
                (this.Tf = {}),
                (this.Pf = Date.now());
            }
            ...
            return (
              ...
              (i.delay = function (t, i) {
                ...
                if (!i) {
                  var r = 'p' + this.Of++;
                  return (
                    this.Ef.then(function () {
                      n.Tf[r] ? delete n.Tf[r] : t();
                    }).catch(Us),
                    r
                  );
                }
        ...
        var ia = (function () {
            function t(t) {
              var i = t.getRootNode(),
                n = i.ownerDocument || i;
              (this.If = n.createElement('a')), (this.Rn = new fs(100));
            }
            var i = t.prototype;
            return (
              (i.parse = function (t, i) {
                return ps(this.If, t, i ? null : this.Rn);
              }),
              (i.Sf = function (t) {
              ...
              (i.getWinOrigin = function (t) {
                return t.origin || this.Sf(t.location.href).origin;
              }),
          ...
          ra = (function () {
            ...
            return (
              (i.expand = function (t) {
                if (!t.length) return this.kf ? t : Promise.resolve(t);
                var i = this.Mf.getExpr(this.Rf, this.fu),
                  n = this.Cf(t, i);
                return n.length
                  ? this.jf(t, n)
                  : this.kf
                  ...
                  for (
                    ...
                    if (u && e === u.start)
                      ...
                      if (o && ')' === t[e] && !h) {
                        e++, o--;
                        var b = r.pop();
                        return g && v.push(g), m.push(v), n.Df(b, m);
                      }
                      (l += t[e]), e++;
                    }
              ...
              (i.Df = function (t, i) {
                ...
                return this.zf(n, e, i).then(function (t) {
              ...
              (i.zf = function (t, i, n) {
                ...
                try {
                  ...
                  return r
                    .then(function (t) {
                      return e.Hf(i, t, n), null == t ? '' : t;
                    })
                    .catch(function (t) {
                      return d(t), e.Hf(i, '', n), Promise.resolve('');
                    });
                } catch (t) {
                  return d(t), this.Hf(i, '', n), Promise.resolve('');
                }
              }),
              (i.Lf = function (t) {
                return Promise.all(
              ...
              (i.Uf = function (t, i, n) {
                try {
                  var r,
                    e = t;
                  return (
                    'function' == typeof t && (e = t.apply(null, this.Gf(n))),
                    e && 'function' == typeof e.then
                      ...
                      : 'string' == typeof e ||
                        'number' == typeof e ||
                        'boolean' == typeof e
                      ? (this.Hf(i, e, n), (r = e.toString()))
                      : (this.Hf(i, '', n), (r = '')),
                    r
                  );
                } catch (t) {
                  return d(t), this.Hf(i, '', n), '';
                }
              }),
              (i.Gf = function (t) {
                return t
        ...
        var la = (function (t) {
            ...
            function n(t) {
              var n;
              return ((n = i.call(this, t)).Vf = null), (n.Ff = {}), n;
            }
            var r = n.prototype;
            return (
              (r.Bf = function (t, i, n) {
              ...
              (r.initialize = function () {
                ...
                this.set('COUNTER', function (t) {
                  ...
                  this.set('CANONICAL_URL', function () {
                    return t.qf().canonicalUrl;
                  }),
                  this.set('CANONICAL_HOST', function () {
                    return ms(t.qf().canonicalUrl).host;
                  }),
                  this.set('CANONICAL_HOSTNAME', function () {
                    return ms(t.qf().canonicalUrl).hostname;
                  }),
                  this.set('CANONICAL_PATH', function () {
                    return ms(t.qf().canonicalUrl).pathname;
                  }),
                ...
                this.setBoth(
                  ...
                  this.set('SOURCE_HOST', function () {
                    return ms(t.qf().sourceUrl).host;
                  }),
                  this.set('SOURCE_HOSTNAME', function () {
                    return ms(t.qf().sourceUrl).hostname;
                  }),
                  this.set('SOURCE_PATH', function () {
                    return ms(t.qf().sourceUrl).pathname;
                  }),
                  this.set('PAGE_VIEW_ID', function () {
                    return t.qf().pageViewId;
                  }),
                  this.setAsync('PAGE_VIEW_ID_64', function () {
                    return t.qf().pageViewId64;
                  }),
                  this.setBoth(
                    'QUERY_PARAM',
                    function (i) {
                ...
                this.set('SCREEN_WIDTH', ca(o, 'width')),
                  ...
                  this.setBoth(
                    ...
                    function (i) {
                      var n;
                      return null !== (n = t.Ff[i]) && void 0 !== n ? n : '';
                    },
                    function (n) {
                      return t.Xf(n, i);
                    }
                  ...
                  this.Bf('TCP_CONNECT_TIME', 'connectStart', 'connectEnd'),
                  this.Bf(
                    'SERVER_RESPONSE_TIME',
                    'requestStart',
                    'responseStart'
                  ),
                  this.Bf('PAGE_DOWNLOAD_TIME', 'responseStart', 'responseEnd'),
                  this.Bf('REDIRECT_TIME', 'navigationStart', 'fetchStart'),
                  this.Bf(
            ...
            (function () {
              ...
              return (
                (i.$o = function () {
                  this.initialize(), (this.tl = !0);
                }),
                (i.initialize = function () {}),
                (i.get = function (t) {
                  return this.tl || this.$o(), this.Zf[t];
                }),
                (i.set = function (t, i) {
                  return (
                ...
                (i.getExpr = function (t, i) {
                  this.tl || this.$o();
                  var n = D(D({}, this.Zf), t);
                  return this.nl(Object.keys(n), i);
                }),
                (i.nl = function (t, i) {
                  var n = this;
                  if (
          ...
          va = (function () {
            function t(t, i) {
              (this.ampdoc = t), (this.Mf = i);
            }
            var i = t.prototype;
            return (
              (i.expandStringSync = function (t, i, n) {
                return new ra(this.Mf, i, void 0, !0, n, !0).expand(t);
              }),
              (i.expandStringAsync = function (t, i, n) {
                return new ra(this.Mf, i, void 0, void 0, n, !0).expand(t);
              }),
              (i.expandUrlSync = function (t, i, n) {
                return this.sl(t, new ra(this.Mf, i, void 0, !0, n).expand(t));
              }),
              (i.expandUrlAsync = function (t, i, n, r) {
                var e = this;
                return new ra(this.Mf, i, void 0, void 0, n, r)
                  .expand(t)
                  .then(function (i) {
                    return e.sl(t, i);
                  });
              ...
              (i.ol = function (t, i) {
                ...
                var r = new ra(this.Mf, void 0, void 0, i, n).expand(
                  t['amp-original-value'] || t.value
                );
                return i
                  ? (t.value = r)
              ...
              (i.collectVars = function (t, i) {
                ...
                return new ra(this.Mf, i, n).expand(t).then(function () {
                  return n;
                });
              }),
              (i.collectDisallowedVarsSync = function (t) {
                var i = t.getAttribute('src'),
                  n = new ra(this.Mf).getMacroNames(i),
                  r = this.ul(t);
                return r
                  ? n.filter(function (t) {
                      return !r[t];
          ...
          pa = (function () {
            function t(t) {
              ...
              (this.ampdoc = t),
                ...
                (this.gl = A()),
                t.isSingleDoc() &&
                  Object.assign(this.gl, yt(this.win.location.hash)),
                (this.La = !parseInt(t.getParam('off'), 10)),
                Qt().fine(da, '- runtimeOn:', this.La),
                (this.al = !(!parseInt(t.getParam('history'), 10) && !this.al)),
                Qt().fine(da, '- history:', this.al),
                Qt().fine(
                  da,
                  '- visibilityState:',
              ...
              if (
                ...
                (this.Sl = Es(this.win.location.href || '')),
                (this.Ml = new Promise(function (n) {
            ...
            return (
              ...
              (i.isWebviewEmbedded = function () {
                return !this.ra && '1' == this.ampdoc.getParam('webview');
              }),
              (i.isCctEmbedded = function () {
                if (null != this.yl) return this.yl;
                if (((this.yl = !1), !this.ra)) {
              ...
              (i.maybeUpdateFragmentForCct = function () {
                if (this.isCctEmbedded() && this.win.history.replaceState) {
                  ...
                  this._l(t, n) &&
                    ((this.gl.ampshare = i),
                    this.win.history.replaceState({}, '', '#' + ws(this.gl)));
                }
              }),
              (i._l = function (t, i) {
                var n = function (t) {
              ...
              (i.toggleRuntime = function () {
                (this.La = !this.La),
                  Qt().fine(da, 'Runtime state:', this.La),
                  this.ll.fire(this.La);
              }),
              (i.onRuntimeState = function (t) {
                return this.ll.add(t);
              }),
                ...
                return (
                  ...
                  this.isCctEmbedded()
                    ...
                    : this.win.location.ancestorOrigins.length > 0 &&
                      this.Nl(this.win.location.ancestorOrigins[0]))
                );
              }),
              ...
              (i.onMessage = function (t, i) {
                var n = this.cl[t];
                n || ((n = new Or()), (this.cl[t] = n));
                var r = n.add(i);
                return (
                  this.bl[t] &&
                    (this.bl[t].forEach(function (t) {
              ...
              (i.onMessageRespond = function (t, i) {
                ...
                return (
                  ...
                  this.bl[t] &&
                    ...
                    (this.bl[t] = [])),
                  function () {
                    n.fl[t] === i && delete n.fl[t];
                  }
                );
              }),
              (i.receiveMessage = function (t, i, n) {
                if ('visibilitychange' == t) return this.kl(i.state), h();
                if ('broadcast' == t) return this.vl.fire(i), h();
                var r = this.cl[t],
                  e = this.fl[t];
                if (!r && !e) {
                  if (
                    ((this.bl[t] = this.bl[t] || []), this.bl[t].length >= 50)
                  )
                    return;
                  var s = new a();
                  return this.bl[t].push({ data: i, deferred: s }), s.promise;
                }
              ...
              (i.setMessageDeliverer = function (t, i) {
                ...
                if (
                  ...
                  var r = this.pl.slice(0);
                  (this.pl = []),
                    r.forEach(function (t) {
                      var i = n.dl(t.eventType, t.data, t.awaitResponse);
              ...
              (i.kt = function (t, i, n, r) {
                ...
                if (!this.xl) return r ? Promise.reject(ga()) : h();
                if (!n)
                  return this.xl.then(function () {
                    return e.dl(t, i, r);
                  });
                var s,
                  u = q(this.pl, function (i) {
                    return i.eventType == t;
                  });
                if (-1 != u)
                  ((s = this.pl.splice(u, 1)[0]).data = i),
                ...
                return this.pl.push(s), s.responsePromise;
              }),
              (i.broadcast = function (t) {
                return this.xl
                  ? this.kt('broadcast', t, !1, !1).then(
                      function () {
                        return !0;
                      },
                      function () {
        ...
        var wa = (function () {
            ...
            return (
              (t.solveYValueFromXValue = function (i, n, r, e, s, u, o, h, a) {
                return t.Cl(t.jl(i, n, e, u, h), r, s, o, a);
              }),
              (t.jl = function (i, n, r, e, s) {
                var u = 1e-6,
                  o = (i - n) / (s - n);
                if (o <= 0) return 0;
                if (o >= 1) return 1;
              ...
              (t.Dl = function (i, n, r, e, s) {
                if (0 == i) return n;
                if (1 == i) return s;
                var u = t.Ul(n, r, i),
                  o = t.Ul(r, e, i),
                  h = t.Ul(e, s, i);
                return (u = t.Ul(u, o, i)), (o = t.Ul(o, h, i)), t.Ul(u, o, i);
              }),
              (t.Cl = function (i, n, r, e, s) {
                if (0 == i) return n;
                if (1 == i) return s;
                var u = t.Ul(n, r, i),
                  o = t.Ul(r, e, i),
        ...
        var Pa = 'Animation',
          ...
          Ia = (function () {
            ...
            return (
              ...
              (i.start = function (t) {
                return new Ta(this.Wh, this.zl, this.Hl, this.Ll, t);
              }),
              t
            );
          })(),
          Ta = (function () {
            function t(t, i, n, r, e) {
              ...
              (this.Vl = o.promise),
                (this.Me = o.resolve),
                (this.Fl = o.reject),
                (this.Bl = this.Wh.createAnimTask(this.zl, {
                  mutate: this.ql.bind(this),
                })),
                this.Wh.canAnimate(this.zl)
                  ? this.Bl(this.je)
                  : (Qt().warn(Pa, 'cannot animate'), this.$l(!1, 0));
            }
            var i = t.prototype;
            return (
              (i.then = function (t, i) {
                return t || i ? this.Vl.then(t, i) : this.Vl;
              }),
              ...
              (i.$l = function (t, i) {
                if (this.ou) {
                  if (((this.ou = !1), 0 != i)) {
                    this.Hl.length > 1 &&
                      this.Hl.sort(function (t, i) {
                        return t.delay + t.duration - (i.delay + i.duration);
                      });
                    try {
                      if (i > 0)
                        for (var n = 0; n < this.Hl.length; n++)
                          this.Hl[n].func(1, !0);
                      else
                        for (var r = this.Hl.length - 1; r >= 0; r--)
                          this.Hl[r].func(0, !1);
                    } catch (i) {
              ...
              (i.ql = function (t) {
                if (this.ou) {
                  for (
                    var i = Date.now(),
                      n = Math.min((i - this.Pf) / this.Gl, 1),
                      r = 0;
                    r < this.Hl.length;
                    r++
                  ) {
                  ...
                  for (var s = 0; s < this.Hl.length; s++) {
                    var u = this.Hl[s];
                    u.started && !u.completed && this.Wl(u, n);
                  }
                  1 == n
                    ? this.$l(!0, 0)
                    : this.Wh.canAnimate(this.zl)
                    ? this.Bl(this.je)
                    : (Qt().warn(Pa, 'cancel animation'), this.$l(!1, 0));
                }
              }),
              (i.Wl = function (t, i) {
                var n, r;
        ...
        var Sa = (function () {
            function t(t) {
              ...
              (this.Kl = s),
                ...
                (this.Yl = new Or()),
                (this.Jl = new Or()),
                (this.Xl = this.Ql.bind(this)),
                (this.Zl = function () {
                  return i.Jl.fire();
                }),
                (this.tv = 0),
                (this.iv = !1),
                Ii(n, this.nv.bind(this)),
                dn(n).then(function () {
            ...
            return (
              ...
              (i.nv = function () {
                if (!this.iv) {
                  ...
                  var t = this.win.document,
                    i = t.body;
                  t.documentElement.appendChild(this.Kl),
                    this.Kl.appendChild(i),
              ...
              (i.connect = function () {
                this.win.addEventListener('resize', this.Zl),
                  this.Kl.addEventListener('scroll', this.Xl);
              }),
              (i.disconnect = function () {
                this.win.removeEventListener('resize', this.Zl),
                  this.Kl.removeEventListener('scroll', this.Xl);
              }),
              ...
              (i.updatePaddingTop = function (t) {
                (this.tv = t), _r(this.Kl, { 'padding-top': Dr(t) });
              }),
              ...
              (i.disableScroll = function () {
                this.Kl.classList.add('i-amphtml-scroll-disabled');
              }),
              (i.resetScroll = function () {
                this.Kl.classList.remove('i-amphtml-scroll-disabled');
              }),
              ...
              (i.getScrollTop = function () {
                return this.Kl.scrollTop;
              }),
              (i.getScrollLeft = function () {
                return 0;
              }),
              (i.getScrollWidth = function () {
                return this.Kl.scrollWidth;
              }),
              (i.getScrollHeight = function () {
                return this.Kl.scrollHeight;
              }),
              ...
              (i.setScrollTop = function (t) {
                this.Kl.scrollTop = t || 1;
              }),
              (i.Ql = function (t) {
                0 == this.Kl.scrollTop &&
                  ((this.Kl.scrollTop = 1), t && t.preventDefault()),
                  t && this.Yl.fire();
              }),
          ...
          Ra = (function () {
            ...
            return (
              ...
              (i.connect = function () {
                this.win.addEventListener('scroll', this.Xl),
                  this.win.addEventListener('resize', this.Zl);
              }),
              (i.disconnect = function () {
                this.win.removeEventListener('scroll', this.Xl),
                  this.win.removeEventListener('resize', this.Zl);
              }),
              (i.ensureReadyForElements = function () {}),
              (i.getBorderTop = function () {
        ...
        var Na = (function () {
          function t(t, i, n) {
            var r = this,
              e = t.win;
            (this.ampdoc = t),
              (this.sv = this.ampdoc.win.document),
              (this.nh = i),
              (this.Mu = n),
              (this.ov = null),
              (this.In = null),
              ...
              (this.hv = !1),
              (this.av = null),
              (this.tv = Number(n.getParam('paddingTop') || 0)),
              (this.cv = 0),
              (this.iu = fr(e)),
              (this.Wh = pr(e)),
              (this.fv = !1),
              ...
              (this.mv = void 0),
              (this.pv = null),
              this.Mu.onMessage('viewport', this.bv.bind(this)),
              this.Mu.onMessage('scroll', this.gv.bind(this)),
              this.Mu.onMessage('disableScroll', this.yv.bind(this)),
              this.Mu.isEmbedded() && this.nh.updatePaddingTop(this.tv),
              this.nh.onScroll(this.wv.bind(this)),
              this.nh.onResize(this.Av.bind(this)),
              this.onScroll(this.xv.bind(this)),
              (this.qa = !1),
              this.ampdoc.onVisibilityChanged(this.Ev.bind(this)),
              this.Ev();
            var s = this.sv.documentElement;
            if (
              ...
              this.nh.overrideGlobalScrollTo())
            )
              try {
          ...
          return (
            ...
            (i.ensureReadyForElements = function () {
              this.nh.ensureReadyForElements();
            }),
            (i.Ev = function () {
              ...
              t != this.qa &&
                ...
                t
                  ? (this.nh.connect(),
                    this.In && this.Av(),
                    this.uv && ((this.uv = null), this.getScrollTop()))
                  : this.nh.disconnect());
            }),
            ...
            (i.getScrollTop = function () {
              return (
                null == this.uv && (this.uv = this.nh.getScrollTop()), this.uv
              );
            }),
            (i.getScrollLeft = function () {
              return (
                null == this.av && (this.av = this.nh.getScrollLeft()), this.av
              );
            }),
            (i.setScrollTop = function (t) {
              (this.uv = null), this.nh.setScrollTop(t);
            }),
            ...
            (i.getSize = function () {
              ...
              if (
                ((this.In = this.nh.getSize()),
                0 == this.In.width || 0 == this.In.height)
              ) {
            ...
            (i.getScrollWidth = function () {
              return this.nh.getScrollWidth();
            }),
            (i.getScrollHeight = function () {
              return this.nh.getScrollHeight();
            }),
            (i.getContentHeight = function () {
              return this.nh.getContentHeight();
            }),
            (i.contentHeightChanged = function () {
              this.nh.contentHeightChanged();
            }),
            (i.getRect = function () {
              if (null == this.ov) {
                var t = this.getScrollTop(),
                  ...
                  n = this.getSize();
                this.ov = zi(i, t, n.width, n.height);
              }
              return this.ov;
            }),
            (i.getLayoutRect = function (t) {
              ...
              if (r) {
                var e = this.nh.getLayoutRect(t, 0, 0),
                  s = this.nh.getLayoutRect(r, i, n);
                return zi(
              ...
              return this.nh.getLayoutRect(t, i, n);
            }),
            (i.getClientRectAsync = function (t) {
              var i = this.Wh.measurePromise(function () {
                  return t.getBoundingClientRect();
                }),
                n = this.nh.getRootClientRectAsync(),
                r = _n(t, this.ampdoc.win);
              return (
                r &&
                  (n = this.Wh.measurePromise(function () {
            ...
            (i.supportsPositionFixed = function () {
              return this.nh.supportsPositionFixed();
            }),
            (i.isDeclaredFixed = function (t) {
              return !!this.pv && this.pv.isDeclaredFixed(t);
            }),
            (i.scrollIntoView = function (t) {
              var i = this;
              return this.Ov(t).then(function (n) {
                return i.Tv(t, n);
              });
            }),
            (i.Tv = function (t, i) {
              var n = this,
                r = this.nh.getLayoutRect(t).top,
                e = Ca(this.ampdoc.win, i);
              c(function () {
                return Math.max(0, r - n.tv - e);
              }).then(function (t) {
                return n.Pv(i, t);
              });
            }),
            ...
            (i.animateScrollWithinParent = function (t, i, n, r, e) {
              var s = this;
              Zt(!e || void 0 !== r);
              var u = this.nh.getLayoutRect(t),
                o = (this.Iv(i) ? this.getSize() : this.getLayoutRect(i))
                  .height,
                h = this.ampdoc.win,
                a = Ca(h, i),
                c = (function (t, i) {
              ...
              return (
                ...
                this.Sv(i).then(function (t) {
                  var n = u.top - s.tv + f,
                    o = Math.max(0, n);
                  if (o != t) return s.Mv(i, t, o, r, e);
                })
              );
            }),
            (i.Mv = function (t, i, n, r) {
              var e = this,
                s =
                  arguments.length > 4 && void 0 !== arguments[4]
                    ? arguments[4]
            ...
            (i.Ov = function (t) {
              var i = this;
              return this.Wh.measurePromise(function () {
                return (
                  yi(t, '.i-amphtml-scrollable') || i.nh.getScrollingElement()
                );
              });
            }),
            (i.Pv = function (t, i) {
              this.Iv(t)
                ? this.nh.setScrollTop(i)
                : this.Wh.mutate(function () {
                    t.scrollTop = i;
                  });
            }),
            (i.Sv = function (t) {
              ...
              return this.Iv(t)
                ...
                : this.Wh.measurePromise(function () {
                    return t.scrollTop;
                  });
            }),
            (i.Iv = function (t) {
              return t == this.nh.getScrollingElement();
            }),
            (i.getScrollingElement = function () {
              return this.xn
                ? this.xn
                : (this.xn = this.nh.getScrollingElement());
            }),
            (i.onChanged = function (t) {
              return this.vv.add(t);
            }),
            (i.onScroll = function (t) {
              return this.Yl.add(t);
            }),
            (i.onResize = function (t) {
              return this.Jl.add(t);
            }),
            (i.enterLightboxMode = function (t, i) {
              return (
                this.Mu.sendMessage('requestFullOverlay', {}, !0),
                this.enterOverlayMode(),
                this.pv && this.pv.enterLightbox(t, i),
                t && this.maybeEnterFieLightboxMode(t),
                this.nh.updateLightboxMode(!0)
              );
            }),
            (i.leaveLightboxMode = function (t) {
              return (
                this.Mu.sendMessage('cancelFullOverlay', {}, !0),
                this.pv && this.pv.leaveLightbox(),
                this.leaveOverlayMode(),
                t && this.maybeLeaveFieLightboxMode(t),
                this.nh.updateLightboxMode(!1)
              );
            }),
            ...
            (i.disableScroll = function () {
              ...
              this.Wh.measure(function () {
                ...
                this.Wh.mutate(function () {
                  kr(r, 'margin-right', t, 'px'), i.nh.disableScroll();
                });
            }),
            (i.resetScroll = function () {
              var t = this,
              ...
              this.Wh.mutate(function () {
                kr(i, 'margin-right', ''), t.nh.resetScroll();
              });
            }),
            (i.resetTouchZoom = function () {
              var t = this,
                i = this.ampdoc.win.innerHeight,
                n = this.sv.documentElement.clientHeight;
              (i && n && i === n) ||
                (this.disableTouchZoom() &&
                  this.iu.delay(function () {
            ...
            (i.restoreOriginalTouchZoom = function () {
              return void 0 !== this.mv && this.kv(this.mv);
            }),
            (i.updateFixedLayer = function () {
              return this.pv ? this.pv.update() : h();
            }),
            (i.addToFixedLayer = function (t, i) {
              return this.pv ? this.pv.addElement(t, i) : h();
            }),
            (i.removeFromFixedLayer = function (t) {
              this.pv && this.pv.removeElement(t);
            }),
            (i.createFixedLayer = function (t) {
              ...
              (this.pv = new t(
                this.ampdoc,
                this.Wh,
                this.nh.getBorderTop(),
                this.tv,
                this.nh.requiresFixedLayerTransfer()
              )),
                this.ampdoc.whenReady().then(function () {
                  return i.pv.setup();
                });
            ...
            (i._v = function () {
              return Ni(this.ampdoc.win)
                ? null
                : (void 0 === this.dv &&
                    ((this.dv = this.sv.querySelector('meta[name=viewport]')),
                    this.dv && (this.mv = this.dv.content)),
                  this.dv);
            }),
            (i.gv = function (t) {
              var i = t.scrollTop;
            ...
            (i.bv = function (t) {
              ...
              if (
                null != n &&
                n != this.tv &&
                ((this.cv = this.tv), (this.tv = n), this.pv)
              ) {
                var u = this.pv.animateFixedElements(this.tv, this.cv, r, e, s);
                n < this.cv
                  ? this.nh.hideViewerHeader(s, this.cv)
                  : u.then(function () {
                      i.nh.showViewerHeader(s, n);
                    });
              }
            }),
            (i.yv = function (t) {
            ...
            (i.wv = function () {
              var t = this;
              (this.ov = null), this.lv++, (this.av = this.nh.getScrollLeft());
              var i = this.nh.getScrollTop();
              if (!(i < 0)) {
                if (((this.uv = i), !this.fv)) {
                  this.fv = !0;
                  var n = Date.now();
                  this.iu.delay(function () {
                    t.Wh.measure(function () {
                      t.bc(n, i);
                    });
                  }, 36);
                }
            ...
            (i.bc = function (t, i) {
              ...
              e != t && (s = (r - i) / (e - t)),
                ...
                Math.abs(s) < 0.03
                  ? (this.Nv(!1, s), (this.fv = !1))
                  : this.iu.delay(function () {
                      return n.Wh.measure(n.bc.bind(n, e, r));
                    }, 20);
            }),
            (i.xv = function () {
              var t = this;
          ...
          La = (function () {
            function t(t) {
              (this.win = t),
                ...
                (this.Lv = null),
                (this.Hv = null),
                (this.Gv = this.Vv.bind(this)),
                (this.Fv = new Uu(this.win, this.Gv, 16)),
                (this.Bv = new Uu(this.win, this.Gv, 40)),
                (this.qv = this.$v.bind(this)),
                this.Cv.isSingleDoc()
                  ? this.Cv.getSingleDoc().onVisibilityChanged(this.qv)
                  : Lr(this.win.document, this.qv);
            }
            var i = t.prototype;
            return (
              (i.dispose = function () {
                zr(this.win.document, this.qv);
              }),
              (i.$v = function () {
                this.eu && this.Wv();
              }),
              (i.run = function (t, i) {
                this.Fs.push(t), this.Uh.push(i || void 0), this.Ys();
              }),
              (i.runPromise = function (t, i) {
                if ((this.run(t, i), this.Lv)) return this.Lv;
                var n = new a();
                return (this.Hv = n.resolve), (this.Lv = n.promise);
              }),
              ...
              (i.Kv = function (t) {
                ...
                if (this.Cv.isSingleDoc())
                  return this.Cv.getSingleDoc().isVisible();
                if (t) {
                  var i = this.Cv.getAmpDocIfAvailable(t);
              ...
              (i.Ys = function () {
                this.eu || ((this.eu = !0), this.Wv());
              }),
              (i.Wv = function () {
                this.Kv()
                  ? (this.jv(this.Gv), this.Bv.schedule())
                  : this.Fv.schedule();
              }),
              (i.Vv = function () {
                this.Bv.cancel(), (this.eu = !1);
                var t = this.Hv,
                  i = this.Uh,
                  n = this.Fs;
                (this.Hv = null),
        ...
        var Ga = 'Input',
          Va = (function () {
            function t(t) {
              (this.win = t),
                ...
                Qt().fine(Ga, 'touch detected:', this.rd),
                (this.ed = !1),
                this.win.document.addEventListener('keydown', this.Yv),
                this.win.document.addEventListener('mousedown', this.Xv),
                (this.sd = !0),
                (this.od = 0),
                (this.ud = new Or()),
                (this.hd = new Or()),
                ...
                this.rd &&
                  ((this.sd = !this.rd),
                  (this.Zv = this.fd.bind(this)),
                  Qe(t.document, 'mousemove', this.Zv));
            }
            var i = t.prototype;
            return (
              (i.setupInputModeClasses = function (t) {
                ...
                this.onTouchDetected(function (n) {
                  i.ld(t, 'amp-mode-touch', n);
                }, !0),
                  this.onMouseDetected(function (n) {
                    i.ld(t, 'amp-mode-mouse', n);
                  }, !0),
                  this.onKeyboardStateChanged(function (n) {
                    i.ld(t, 'amp-mode-keyboard-active', n);
                  }, !0);
              }),
              ...
              (i.onTouchDetected = function (t, i) {
                return i && t(this.isTouchDetected()), this.ud.add(t);
              }),
              (i.isMouseDetected = function () {
                return this.sd;
              }),
              (i.onMouseDetected = function (t, i) {
                return i && t(this.isMouseDetected()), this.hd.add(t);
              }),
              (i.isKeyboardActive = function () {
                return this.ed;
              }),
              (i.onKeyboardStateChanged = function (t, i) {
                return i && t(this.isKeyboardActive()), this.ad.add(t);
              }),
              (i.ld = function (t, i, n) {
                var r = this;
              ...
              (i.fd = function (t) {
                ...
                if (
                  ...
                  var n;
                  this.nd ||
                    ((this.nd = this.vd.bind(this)),
                    (this.td = this.dd.bind(this)));
              ...
              (i.dd = function () {
                this.od++,
                  this.od <= 3
                    ? Qe(this.win.document, 'mousemove', this.Zv)
          ...
          $a = (function () {
            function t(t) {
              (this.md = t.document),
                (this.pd = t.document.head),
                (this.bd = {}),
                (this.gd = {}),
                (this.ia = or(t)),
                (this.bd[ms(t.location.href).origin] = !0),
                (this.yd = (function (t) {
                  if (!qa) {
            ...
            return (
              ...
              (i.xd = function (t) {
                ...
                i.setAttribute('href', t),
                  this.yd.onlyValidAs ? (i.as = 'fetch') : (i.as = ''),
                  this.pd.appendChild(i);
              }),
              (i.wd = function (t) {
              ...
              (i.Ad = function (t, i) {
                if (
                  !this.yd.preconnect &&
                  (this.ia.isSafari() || this.ia.isIos())
                ) {
                  var n = Date.now();
                  this.bd[i] = n + Ba;
                  var r =
          ...
          return (
            (i.coreServicesAvailable = function () {
              ...
              (this.Ze = Kn(i)),
                ...
                (this.sm = ir(this.Ze)),
                (this.am =
                  this.Mu.isEmbedded() && '1' === this.Mu.getParam('csi')),
                this.Ze.onVisibilityChanged(this.flush.bind(this)),
                this._m();
              var n = this.Mu.whenMessagingReady();
              return (
                this.Ze.whenFirstVisible().then(function () {
                  t.tick('ofv'), t.flush();
                }),
                (this.wm || this.bm) && this.Ze.onVisibilityChanged(this.Em),
                n
                  ? n
                      .then(function () {
                        t.tickDelta('msr', t.win.performance.now()),
                          t.tick('timeOrigin', void 0, t.om);
                        var i = t.Ze.getMetaByName('amp-usqp');
                        return (
                          i &&
                            i.split(',').forEach(function (i) {
            ...
            (i.Om = function () {
              ...
              if ('inabox' !== Dt(this.win).runtime) {
                      ...
                      if ('first-contentful-paint' != s.name || n)
                        if ('first-input' !== s.entryType || r)
                          'layout-shift' === s.entryType
                            ? s.hadRecentInput || (t.Cm(s), (t.gm += s.value))
                ...
                this.win.PerformancePaintTiming &&
                  ...
                  u.push('paint')),
                  this.ym && this.jm(s, { type: 'first-input', buffered: !0 }),
                  this.bm && this.jm(s, { type: 'layout-shift', buffered: !0 }),
                  this.wm &&
                    this.jm(s, {
                      type: 'largest-contentful-paint',
                      buffered: !0,
                    }),
                  this.Am && this.jm(s, { type: 'navigation', buffered: !0 }),
                  this.xm &&
                    this.jm(s, {
                      type: 'event',
                  ...
                  u.length > 0 && this.jm(s, { entryTypes: u });
              }
            }),
            (i.jm = function (t, i) {
              var n = this;
            ...
            (i.Dm = function () {
              var t = this.Ze.getVisibilityState();
              return t === Pr || t === xr;
            }),
            (i.Em = function () {
              this.Dm() && (this.Lm(), this.Sm());
            }),
            (i.Um = function () {
              if (!this.Im) {
                this.Im = !0;
            ...
            (i.zm = function () {
              0 === this.dm
                ? (this.tickDelta(nn, this.gm), this.flush(), (this.dm = 1))
                : 1 === this.dm &&
                  (this.tickDelta('cls-2', this.gm),
                  this.flush(),
                  (this.dm = 2));
            }),
            (i.Nm = function (t) {
            ...
            (i._m = function () {
              var t = this,
                i = !this.Ze.hasBeenVisible(),
                n = -1;
              this.Ze.whenFirstVisible().then(function () {
                (n = t.win.performance.now()), t.mark('visible');
              }),
                this.Hm().then(function () {
                  if (i) {
                    var r = n > -1 ? t.win.performance.now() - n : 0;
                    t.Ze.whenFirstVisible().then(function () {
                      t.tickDelta(rn, r);
                    }),
                      t.Gm(r),
                      t.mark(rn);
                  } else t.tick(rn), t.Gm(t.win.performance.now() - n);
                  t.flush();
                });
            }),
            (i.Hm = function () {
              var t = this;
              return this._e.whenFirstPass().then(function () {
                var i,
            ...
            (i.tickSinceVisible = function (t, i) {
              var n,
                ...
                s = this.om + e,
                u =
                  null !== (n = this.Mu) && void 0 !== n && n.isEmbedded()
                    ? null === (r = this.Ze) || void 0 === r
                      ? void 0
            ...
            (i.flush = function () {
              this.hm &&
                this.am &&
                (null == this.lm && (this.lm = Object.keys(this.fm).join(',')),
                this.Mu.sendMessage(
                  'sendCsi',
                  {
                    ampexp: this.lm,
                    canonicalUrl: this.sm.canonicalUrl,
                    eventid: this.rm,
                  },
                  !0
                ));
            ...
            (i.addEnabledExperiment = function (t) {
              (this.fm[t] = !0), (this.lm = void 0);
            }),
            (i.Vm = function (t) {
              this.um.length >= 50 && this.um.shift(), this.um.push(t);
            }),
            (i.km = function () {
              var t = this;
              this.Mu &&
                (this.am
                  ? (this.um.forEach(function (i) {
                      t.Mu.sendMessage('tick', i);
                    }),
                    (this.um.length = 0))
                  : (this.um.length = 0));
            }),
            (i.Gm = function (t) {
              this.Mu &&
                this.Mu.sendMessage('prerenderComplete', { value: t }, !0);
            }),
            (i.isPerformanceTrackingOn = function () {
              return this.am;
            }),
            (i.getMetric = function (t) {
              return this.vm.whenSignal(t);
            }),
            t
          );
        })();
        ...
        var tc = (function () {
            function t(t, i) {
              (this.mi = t),
                ...
                (this.Hp = !1),
                (this.Gp = 0),
                (this.Vp = this.br.bind(this)),
                (this.Fp = this.wr.bind(this)),
                (this.Bp = this.kr.bind(this)),
                (this.qp = this.$p.bind(this)),
                this.mi.addEventListener('touchstart', this.Vp, !0);
            }
            var i = t.prototype;
            return (
              (i.cleanup = function () {
                this.Wp(),
                  this.mi.removeEventListener('touchstart', this.Vp, !0);
              }),
              (i.br = function (t) {
                this.Hp ||
                  !t.touches ||
                  1 != t.touches.length ||
                  this.$h.getScrollTop() > 0 ||
                  this.Yp(t.touches[0].clientY);
              }),
              (i.Yp = function (t) {
                (this.Hp = !0),
                  (this.Gp = t),
                  this.mi.addEventListener('touchmove', this.Fp, !0),
                  this.mi.addEventListener('touchend', this.Bp, !0),
                  this.mi.addEventListener('touchcancel', this.qp, !0);
              }),
              (i.Wp = function () {
                (this.Hp = !1),
                  (this.Gp = 0),
                  this.mi.removeEventListener('touchmove', this.Fp, !0),
                  this.mi.removeEventListener('touchend', this.Bp, !0),
                  this.mi.removeEventListener('touchcancel', this.qp, !0);
              }),
              (i.wr = function (t) {
                if (this.Hp) {
                  var i = t.touches[0].clientY - this.Gp;
                  i > 0 && t.preventDefault(), 0 != i && this.Wp();
                }
              }),
              (i.kr = function (t) {
                this.Wp();
          ...
          uc = (function () {
            ...
            return (
              (i.registerExtension = function (t, i, n, r, e) {
                ...
                if (((o.latest = n), !o.loaded)) {
                  ...
                  try {
                    ...
                    (this.Od = null), (this.Td = null), (this.Pd = null);
                  }
                }
              }),
              (i.waitForExtension = function (t, i) {
                var n = this.Sd(this.Id(t, i));
                return fr(this.win)
              ...
              (i.preloadExtension = function (t) {
                ...
                var n = this.Id(t, i);
                return this.Md(t, i, n), this.Sd(n);
              }),
              ...
              (i.addElement = function (t, i, n) {
                var r = this;
                (this.Rd(t).extension.elements[t] = {
              ...
              (i.addTemplate = function (t, i) {
                this.addDocFactory(function (n) {
                  !(function (t, i, n) {
                    In(t, 'templates').xf(i, n);
                  })(n, t, i);
                });
              }),
              (i._d = function (t, i, n, r) {
                var e = this;
                r
                  ? rs(
                      t,
              ...
              (i.addService = function (t, i) {
                this.Rd(t).extension.services.push({
                  serviceName: t,
                  serviceClass: i,
                }),
                  this.addDocFactory(function (n) {
              ...
              (i.addDocFactory = function (t, i) {
                var n = this.Rd(i);
                if (
                  (n.docFactories.push(t), this.Od && this.Cv.isSingleDoc())
                ) {
                  var r = this.Cv.getAmpDoc(this.win.document),
                    e = this.Od,
                    s = this.Td,
                    u = this.Pd || !1;
              ...
              (i.installExtensionInDoc = function (t, i) {
                ...
                return (
                  t.declareExtension(i, r),
                  this.Sd(this.Id(i, r)).then(function () {
                    n.Id(i, r).docFactories.forEach(function (n) {
                      try {
                        n(t);
                      } catch (t) {
              ...
              (i.Rd = function (t) {
                return (
                  this.Od || Qt().error(nc, 'unknown extension for ', t),
                  this.Id(this.Od || '_UNKNOWN_', this.Td || '')
                );
              }),
              (i.Sd = function (t) {
                if (!t.promise)
        ...
        Zs(self.document, function () {
          ...
          self.console &&
            (console.info || console.log).call(
              console,
              'Powered by AMP ⚡ HTML – Version '.concat('2406131415000'),
              self.location.href
            ),
